...
class HXCPP_CLASS_ATTRIBUTES Connection_obj {
	public:
		...
		static inline ::Dynamic request( ::Dynamic _hx_,::String s) {
			return (_hx_.mPtr->*( static_cast< ::sys::db::Connection_obj *>(_hx_.mPtr->_hx_getInterface(0x6e7a3d49)))->_hx_request)(s);
		}
		void (hx::Object :: *_hx_close)(); 
		static inline void close( ::Dynamic _hx_) {
			(_hx_.mPtr->*( static_cast< ::sys::db::Connection_obj *>(_hx_.mPtr->_hx_getInterface(0x6e7a3d49)))->_hx_close)();
		}
};
