...
HX_DECLARE_STACK_FRAME(_hx_pos_a59bd2e504ea207a_1116_new)
...
HXLINE(1118)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->type = type;
HXLINE(1119)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->windowID = windowID;
HXLINE(1120)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->width = width;
HXLINE(1121)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->height = height;
HXLINE(1122)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->x = x;
HXLINE(1123)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->y = y;
            	}
