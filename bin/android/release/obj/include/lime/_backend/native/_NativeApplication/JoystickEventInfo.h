...
HX_DECLARE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_829_new)
...
HXLINE( 831)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->type = type;
HXLINE( 832)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->id = id;
HXLINE( 833)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->index = index;
HXLINE( 834)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->value = value;
HXLINE( 835)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->x = x;
HXLINE( 836)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->y = y;
            	}
