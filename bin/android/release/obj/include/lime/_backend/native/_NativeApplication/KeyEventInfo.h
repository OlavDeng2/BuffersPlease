...
HX_DECLARE_STACK_FRAME(_hx_pos_4be9d6956d8ea946_873_new)
...
HXLINE( 875)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->type = type;
HXLINE( 876)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->windowID = windowID;
HXLINE( 877)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->keyCode = keyCode;
HXLINE( 878)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->modifier = modifier;
            	}
