...
HX_DECLARE_STACK_FRAME(_hx_pos_3b7a66bddb205621_786_new)
...
HXLINE( 788)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->type = type;
HXLINE( 789)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->id = id;
HXLINE( 790)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->button = button;
HXLINE( 791)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->axis = axis;
HXLINE( 792)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->value = value;
            	}
