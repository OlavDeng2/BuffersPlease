...
HX_DECLARE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1072_new)
...
HXLINE(1074)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->type = type;
HXLINE(1075)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->x = x;
HXLINE(1076)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->y = y;
HXLINE(1077)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->id = id;
HXLINE(1078)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dx = dx;
HXLINE(1079)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dy = dy;
HXLINE(1080)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE(1081)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->device = device;
            	}
