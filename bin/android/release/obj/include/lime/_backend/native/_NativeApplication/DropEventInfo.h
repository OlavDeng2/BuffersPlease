...
HX_DECLARE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_751_new)
...
HXLINE( 753)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->type = type;
HXLINE( 754)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->file = file;
            	}
