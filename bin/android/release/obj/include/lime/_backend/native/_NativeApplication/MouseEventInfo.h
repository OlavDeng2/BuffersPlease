...
HX_DECLARE_STACK_FRAME(_hx_pos_e3566ee739d748b6_914_new)
...
HXLINE( 916)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->type = type;
HXLINE( 917)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->windowID = (int)0;
HXLINE( 918)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->x = x;
HXLINE( 919)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->y = y;
HXLINE( 920)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->button = button;
HXLINE( 921)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->movementX = movementX;
HXLINE( 922)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->movementY = movementY;
            	}
