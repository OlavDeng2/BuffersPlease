...
HX_DECLARE_STACK_FRAME(_hx_pos_36f3917dca2bced0_7_new)
...
{
            	HX_STACKFRAME(&_hx_pos_36f3917dca2bced0_7_new)
HXLINE(  13)		( ( ::lime::graphics::opengl::ext::EXT_sRGB)(__this) )->FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING_EXT = (int)33296;
HXLINE(  12)		( ( ::lime::graphics::opengl::ext::EXT_sRGB)(__this) )->SRGB8_ALPHA8_EXT = (int)35907;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::EXT_sRGB)(__this) )->SRGB_ALPHA_EXT = (int)35906;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_sRGB)(__this) )->SRGB_EXT = (int)35904;
            	}
