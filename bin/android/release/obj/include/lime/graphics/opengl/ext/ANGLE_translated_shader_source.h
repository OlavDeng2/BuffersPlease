...
HX_DECLARE_STACK_FRAME(_hx_pos_276be14287d0ce94_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::ANGLE_translated_shader_source)(__this) )->TRANSLATED_SHADER_SOURCE_LENGTH_ANGLE = (int)37792;
            	}
