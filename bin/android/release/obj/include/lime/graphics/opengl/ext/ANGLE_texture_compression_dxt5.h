...
HX_DECLARE_STACK_FRAME(_hx_pos_958283fb81ddd880_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::ANGLE_texture_compression_dxt5)(__this) )->COMPRESSED_RGBA_S3TC_DXT5_ANGLE = (int)33779;
            	}
