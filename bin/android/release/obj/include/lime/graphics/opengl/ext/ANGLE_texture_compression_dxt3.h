...
HX_DECLARE_STACK_FRAME(_hx_pos_b30108ea6b58727c_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::ANGLE_texture_compression_dxt3)(__this) )->COMPRESSED_RGBA_S3TC_DXT3_ANGLE = (int)33778;
            	}
