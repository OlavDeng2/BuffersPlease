...
HX_DECLARE_STACK_FRAME(_hx_pos_2b1cc31c43c675de_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::APPLE_texture_max_level)(__this) )->TEXTURE_MAX_LEVEL_APPLE = (int)33085;
            	}
