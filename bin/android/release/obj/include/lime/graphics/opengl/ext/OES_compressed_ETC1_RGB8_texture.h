...
HX_DECLARE_STACK_FRAME(_hx_pos_d9cc39cd2e451b00_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::OES_compressed_ETC1_RGB8_texture)(__this) )->ETC1_RGB8_OES = (int)36196;
            	}
