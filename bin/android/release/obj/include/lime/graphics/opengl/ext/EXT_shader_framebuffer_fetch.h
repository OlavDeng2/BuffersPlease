...
HX_DECLARE_STACK_FRAME(_hx_pos_c2a15eaaaac5f681_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::EXT_shader_framebuffer_fetch)(__this) )->FRAGMENT_SHADER_DISCARDS_SAMPLES_EXT = (int)35410;
            	}
