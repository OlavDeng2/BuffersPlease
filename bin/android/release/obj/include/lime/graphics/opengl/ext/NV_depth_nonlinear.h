...
HX_DECLARE_STACK_FRAME(_hx_pos_651bef4d6f261626_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::NV_depth_nonlinear)(__this) )->DEPTH_COMPONENT16_NONLINEAR_NV = (int)36396;
            	}
