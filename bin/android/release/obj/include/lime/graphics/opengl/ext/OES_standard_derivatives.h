...
HX_DECLARE_STACK_FRAME(_hx_pos_20db0725ba88843e_10_new)
...
HXDLIN(  10)		( ( ::lime::graphics::opengl::ext::OES_standard_derivatives)(__this) )->FRAGMENT_SHADER_DERIVATIVE_HINT_OES = (int)35723;
            	}
