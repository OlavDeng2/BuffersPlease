...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::ANGLE_texture_usage)(__this) )->FRAMEBUFFER_ATTACHMENT_ANGLE = (int)37795;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::ANGLE_texture_usage)(__this) )->TEXTURE_USAGE_ANGLE = (int)37794;
            	}
