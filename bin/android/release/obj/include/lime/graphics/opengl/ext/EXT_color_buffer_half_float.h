...
HX_DECLARE_STACK_FRAME(_hx_pos_15fbe66fa7b31d40_7_new)
...
{
            	HX_STACKFRAME(&_hx_pos_15fbe66fa7b31d40_7_new)
HXLINE(  19)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->UNSIGNED_NORMALIZED_EXT = (int)35863;
HXLINE(  18)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE_EXT = (int)33297;
HXLINE(  15)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->R16F_EXT = (int)33325;
HXLINE(  14)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->RG16F_EXT = (int)33327;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->RGB16F_EXT = (int)34843;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->RGBA16F_EXT = (int)34842;
            	}
