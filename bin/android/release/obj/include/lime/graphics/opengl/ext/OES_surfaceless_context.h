...
HX_DECLARE_STACK_FRAME(_hx_pos_e453a9408eead012_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::OES_surfaceless_context)(__this) )->FRAMEBUFFER_UNDEFINED_OES = (int)33305;
            	}
