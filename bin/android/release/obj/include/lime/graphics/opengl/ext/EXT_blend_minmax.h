...
HX_DECLARE_STACK_FRAME(_hx_pos_60db2844fe3361da_7_new)
...
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::EXT_blend_minmax)(__this) )->MAX_EXT = (int)32776;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_blend_minmax)(__this) )->MIN_EXT = (int)32775;
            	}
