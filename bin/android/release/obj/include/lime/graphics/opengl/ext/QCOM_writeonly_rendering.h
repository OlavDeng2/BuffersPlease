...
HX_DECLARE_STACK_FRAME(_hx_pos_e1536ec9c60761cf_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::QCOM_writeonly_rendering)(__this) )->WRITEONLY_RENDERING_QCOM = (int)34851;
            	}
