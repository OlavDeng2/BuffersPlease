...
HX_DECLARE_STACK_FRAME(_hx_pos_15a8768f3739a6a3_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::ARM_mali_program_binary)(__this) )->MALI_PROGRAM_BINARY_ARM = (int)36705;
            	}
