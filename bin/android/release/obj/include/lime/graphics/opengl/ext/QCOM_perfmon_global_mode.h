...
HX_DECLARE_STACK_FRAME(_hx_pos_8723c151069cfd66_7_new)
...
HXDLIN(   7)		( ( ::lime::graphics::opengl::ext::QCOM_perfmon_global_mode)(__this) )->PERFMON_GLOBAL_MODE_QCOM = (int)36768;
            	}
