...
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_shadow_samplers)(__this) )->SAMPLER_2D_SHADOW_EXT = (int)35682;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_shadow_samplers)(__this) )->COMPARE_REF_TO_TEXTURE_EXT = (int)34894;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_shadow_samplers)(__this) )->TEXTURE_COMPARE_FUNC_EXT = (int)34893;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_shadow_samplers)(__this) )->TEXTURE_COMPARE_MODE_EXT = (int)34892;
            	}
