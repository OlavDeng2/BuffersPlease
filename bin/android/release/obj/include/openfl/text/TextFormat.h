...
HX_DECLARE_STACK_FRAME(_hx_pos_c5f39c48023aa9de_33_new)
...
HXLINE(  35)		( ( ::openfl::text::TextFormat)(__this) )->font = font;
HXLINE(  36)		( ( ::openfl::text::TextFormat)(__this) )->size = size;
HXLINE(  37)		( ( ::openfl::text::TextFormat)(__this) )->color = color;
HXLINE(  38)		( ( ::openfl::text::TextFormat)(__this) )->bold = bold;
HXLINE(  39)		( ( ::openfl::text::TextFormat)(__this) )->italic = italic;
HXLINE(  40)		( ( ::openfl::text::TextFormat)(__this) )->underline = underline;
HXLINE(  41)		( ( ::openfl::text::TextFormat)(__this) )->url = url;
HXLINE(  42)		( ( ::openfl::text::TextFormat)(__this) )->target = target;
HXLINE(  43)		( ( ::openfl::text::TextFormat)(__this) )->align = align;
HXLINE(  44)		( ( ::openfl::text::TextFormat)(__this) )->leftMargin = leftMargin;
HXLINE(  45)		( ( ::openfl::text::TextFormat)(__this) )->rightMargin = rightMargin;
HXLINE(  46)		( ( ::openfl::text::TextFormat)(__this) )->indent = indent;
HXLINE(  47)		( ( ::openfl::text::TextFormat)(__this) )->leading = leading;
            	}
