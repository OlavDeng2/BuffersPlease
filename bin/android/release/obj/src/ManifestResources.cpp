...
HXLINE(  27)		::String rootPath = null();
HXLINE(  29)		bool _hx_tmp;
HXDLIN(  29)		if (hx::IsNotNull( config )) {
HXLINE(  29)			_hx_tmp = ::Reflect_obj::hasField(config,HX_("assetsPrefix",75,5a,70,e4));
            		}
            		else {
HXLINE(  29)			_hx_tmp = false;
            		}
HXDLIN(  29)		if (_hx_tmp) {
HXLINE(  31)			rootPath = ( (::String)(::Reflect_obj::field(config,HX_("assetsPrefix",75,5a,70,e4))) );
            		}
HXLINE(  35)		if (hx::IsNull( rootPath )) {
HXLINE(  42)			rootPath = HX_("",00,00,00,00);
            		}
HXLINE(  47)		::lime::utils::Assets_obj::defaultRootPath = rootPath;
HXLINE(  50)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__fonts_times_ttf >());
HXLINE(  51)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__fonts_timesbd_ttf >());
HXLINE(  52)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__fonts_timesbi_ttf >());
HXLINE(  53)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__fonts_timesi_ttf >());
HXLINE(  57)		 ::Dynamic data;
HXDLIN(  57)		 ::Dynamic manifest;
HXDLIN(  57)		 ::lime::utils::AssetLibrary library;
HXLINE(  59)		{
HXLINE(  59)			::String v = (rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  59)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
