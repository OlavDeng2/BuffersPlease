...
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_299_isLocal,"lime.utils.Assets","isLocal",0x6de3bdec,"lime.utils.Assets.isLocal","lime/utils/Assets.hx",299,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_325_isValidAudio,"lime.utils.Assets","isValidAudio",0xfba1fa19,"lime.utils.Assets.isValidAudio","lime/utils/Assets.hx",325,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_334_isValidImage,"lime.utils.Assets","isValidImage",0x918aa09e,"lime.utils.Assets.isValidImage","lime/utils/Assets.hx",334,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_339_list,"lime.utils.Assets","list",0x96ec2eb3,"lime.utils.Assets.list","lime/utils/Assets.hx",339,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_360_loadAsset,"lime.utils.Assets","loadAsset",0x8c6c0f75,"lime.utils.Assets.loadAsset","lime/utils/Assets.hx",360,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_424_loadAsset,"lime.utils.Assets","loadAsset",0x8c6c0f75,"lime.utils.Assets.loadAsset","lime/utils/Assets.hx",424,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_453_loadAudioBuffer,"lime.utils.Assets","loadAudioBuffer",0xa72805bb,"lime.utils.Assets.loadAudioBuffer","lime/utils/Assets.hx",453,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_460_loadBytes,"lime.utils.Assets","loadBytes",0x23caadf0,"lime.utils.Assets.loadBytes","lime/utils/Assets.hx",460,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_467_loadFont,"lime.utils.Assets","loadFont",0xbb998fea,"lime.utils.Assets.loadFont","lime/utils/Assets.hx",467,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_474_loadImage,"lime.utils.Assets","loadImage",0x239bc4e0,"lime.utils.Assets.loadImage","lime/utils/Assets.hx",474,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_507_loadLibrary,"lime.utils.Assets","loadLibrary",0x93baf7c0,"lime.utils.Assets.loadLibrary","lime/utils/Assets.hx",507,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_532_loadLibrary,"lime.utils.Assets","loadLibrary",0x93baf7c0,"lime.utils.Assets.loadLibrary","lime/utils/Assets.hx",532,0x95055f23)
...
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_545_loadText,"lime.utils.Assets","loadText",0xc4d2fec8,"lime.utils.Assets.loadText","lime/utils/Assets.hx",545,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_550_registerLibrary,"lime.utils.Assets","registerLibrary",0xb6301ea3,"lime.utils.Assets.registerLibrary","lime/utils/Assets.hx",550,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_577_unloadLibrary,"lime.utils.Assets","unloadLibrary",0xc816d6c7,"lime.utils.Assets.unloadLibrary","lime/utils/Assets.hx",577,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_598___libraryNotFound,"lime.utils.Assets","__libraryNotFound",0x7dfa37b5,"lime.utils.Assets.__libraryNotFound","lime/utils/Assets.hx",598,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_626_library_onChange,"lime.utils.Assets","library_onChange",0x3a89dec8,"lime.utils.Assets.library_onChange","lime/utils/Assets.hx",626,0x95055f23)
...
bool useCache = __o_useCache.Default(true);
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_299_isLocal)
HXLINE( 303)		bool _hx_tmp;
HXDLIN( 303)		if (useCache) {
HXLINE( 303)			_hx_tmp = ::lime::utils::Assets_obj::cache->enabled;
            		}
            		else {
HXLINE( 303)			_hx_tmp = false;
            		}
HXDLIN( 303)		if (_hx_tmp) {
HXLINE( 305)			if (::lime::utils::Assets_obj::cache->exists(id,type)) {
HXLINE( 305)				return true;
            			}
            		}
HXLINE( 309)		::String symbol_symbolName;
HXDLIN( 309)		::String symbol_libraryName;
HXDLIN( 309)		 ::lime::utils::AssetLibrary symbol_library;
HXDLIN( 309)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXDLIN( 309)		symbol_libraryName = id.substring((int)0,colonIndex);
HXDLIN( 309)		symbol_symbolName = id.substring((colonIndex + (int)1),null());
HXDLIN( 309)		symbol_library = ::lime::utils::Assets_obj::getLibrary(symbol_libraryName);
HXLINE( 310)		if (hx::IsNotNull( symbol_library )) {
HXLINE( 310)			return symbol_library->isLocal(symbol_symbolName,type);
            		}
            		else {
...
bool Assets_obj::isValidAudio( ::lime::media::AudioBuffer buffer){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_325_isValidAudio)
HXDLIN( 325)		return hx::IsNotNull( buffer );
            	}
...
bool Assets_obj::isValidImage( ::lime::graphics::Image image){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_334_isValidImage)
HXDLIN( 334)		if (hx::IsNotNull( image )) {
HXDLIN( 334)			return hx::IsNotNull( image->buffer );
            		}
            		else {
...
::Array< ::String > Assets_obj::list(::String type){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_339_list)
HXLINE( 341)		::Array< ::String > items = ::Array_obj< ::String >::__new(0);
HXLINE( 343)		{
HXLINE( 343)			 ::Dynamic library = ::lime::utils::Assets_obj::libraries->iterator();
HXDLIN( 343)			while(( (bool)(library->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 343)				 ::lime::utils::AssetLibrary library1 = ( ( ::lime::utils::AssetLibrary)(library->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 345)				::Array< ::String > libraryItems = library1->list(type);
HXLINE( 347)				if (hx::IsNotNull( libraryItems )) {
HXLINE( 349)					items = items->concat(libraryItems);
            				}
            			}
            		}
HXLINE( 355)		return items;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,list,return )
 ...
 ::lime::app::Future Assets_obj::loadAsset(::String id,::String type,bool useCache){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_360_loadAsset)
HXLINE( 364)		bool _hx_tmp;
HXDLIN( 364)		if (useCache) {
HXLINE( 364)			_hx_tmp = ::lime::utils::Assets_obj::cache->enabled;
            		}
            		else {
...
HXLINE( 366)			::String _hx_switch_0 = type;
            			if (  (_hx_switch_0==HX_("BINARY",01,68,8e,9f)) ||  (_hx_switch_0==HX_("TEXT",ad,94,ba,37)) ){
HXLINE( 370)				useCache = false;
HXDLIN( 370)				goto _hx_goto_15;
            			}
            			if (  (_hx_switch_0==HX_("FONT",cf,25,81,2e)) ){
HXLINE( 374)				 ::Dynamic font = ::haxe::IMap_obj::get(::lime::utils::Assets_obj::cache->font,id);
HXLINE( 376)				if (hx::IsNotNull( font )) {
HXLINE( 378)					return ::lime::app::Future_obj::withValue(font);
            				}
HXLINE( 372)				goto _hx_goto_15;
            			}
            			if (  (_hx_switch_0==HX_("IMAGE",3b,57,57,3b)) ){
HXLINE( 384)				 ::lime::graphics::Image image = ( ( ::lime::graphics::Image)(::haxe::IMap_obj::get(::lime::utils::Assets_obj::cache->image,id)) );
HXLINE( 386)				if (::lime::utils::Assets_obj::isValidImage(image)) {
HXLINE( 388)					return ::lime::app::Future_obj::withValue(image);
            				}
HXLINE( 382)				goto _hx_goto_15;
            			}
            			if (  (_hx_switch_0==HX_("MUSIC",85,08,49,8e)) ||  (_hx_switch_0==HX_("SOUND",af,c4,ba,fe)) ){
HXLINE( 394)				 ::lime::media::AudioBuffer audio = ( ( ::lime::media::AudioBuffer)(::haxe::IMap_obj::get(::lime::utils::Assets_obj::cache->audio,id)) );
HXLINE( 396)				if (::lime::utils::Assets_obj::isValidAudio(audio)) {
HXLINE( 398)					return ::lime::app::Future_obj::withValue(audio);
            				}
HXLINE( 392)				goto _hx_goto_15;
            			}
            			if (  (_hx_switch_0==HX_("TEMPLATE",3a,78,cd,05)) ){
HXLINE( 404)				HX_STACK_DO_THROW((HX_("Not sure how to get template: ",a1,19,8c,ad) + id));
HXDLIN( 404)				goto _hx_goto_15;
            			}
            			/* default */{
...
HXLINE( 414)		::String symbol_symbolName;
HXDLIN( 414)		::String symbol_libraryName;
HXDLIN( 414)		 ::lime::utils::AssetLibrary symbol_library;
HXDLIN( 414)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXDLIN( 414)		symbol_libraryName = id.substring((int)0,colonIndex);
HXDLIN( 414)		symbol_symbolName = id.substring((colonIndex + (int)1),null());
HXDLIN( 414)		symbol_library = ::lime::utils::Assets_obj::getLibrary(symbol_libraryName);
HXLINE( 416)		if (hx::IsNotNull( symbol_library )) {
HXLINE( 418)			if (symbol_library->exists(symbol_symbolName,type)) {
HXLINE( 420)				 ::lime::app::Future future = symbol_library->loadAsset(symbol_symbolName,type);
HXLINE( 422)				bool _hx_tmp1;
HXDLIN( 422)				if (useCache) {
HXLINE( 422)					_hx_tmp1 = ::lime::utils::Assets_obj::cache->enabled;
            				}
            				else {
...
HXDLIN( 422)				if (_hx_tmp1) {
            					...
            					void _hx_run( ::Dynamic asset){
            						HX_STACKFRAME(&_hx_pos_df5754140b017d9f_424_loadAsset)
HXLINE( 424)						::lime::utils::Assets_obj::cache->set(id,type,asset);
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 424)					future->onComplete( ::Dynamic(new _hx_Closure_0(id,type)));
            				}
HXLINE( 428)				return future;
            			}
            			else {
HXLINE( 432)				return ::lime::app::Future_obj::withError(((((HX_("There is no ",e5,bb,ab,c5) + type) + HX_(" asset with an ID of \"",95,f2,3a,0d)) + id) + HX_("\"",22,00,00,00)));
            			}
            		}
            		else {
HXLINE( 438)			return ::lime::app::Future_obj::withError(::lime::utils::Assets_obj::_hx___libraryNotFound(symbol_libraryName));
            		}
...
bool useCache = __o_useCache.Default(true);
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_453_loadAudioBuffer)
HXDLIN( 453)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("SOUND",af,c4,ba,fe),useCache);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadAudioBuffer,return )
 ...
 ::lime::app::Future Assets_obj::loadBytes(::String id){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_460_loadBytes)
HXDLIN( 460)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("BINARY",01,68,8e,9f),false);
            	}
...
bool useCache = __o_useCache.Default(true);
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_467_loadFont)
HXDLIN( 467)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("FONT",cf,25,81,2e),useCache);
            	}
...
bool useCache = __o_useCache.Default(true);
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_474_loadImage)
HXDLIN( 474)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("IMAGE",3b,57,57,3b),useCache);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadImage,return )
 ...
 ::lime::app::Future Assets_obj::loadLibrary(::String id){
            		...
            		void _hx_run( ::lime::utils::AssetManifest manifest){
            			HX_GC_STACKFRAME(&_hx_pos_df5754140b017d9f_507_loadLibrary)
HXLINE( 509)			if (hx::IsNull( manifest )) {
HXLINE( 511)				promise->error(((HX_("Cannot parse asset manifest for library \"",cf,1e,cc,48) + id) + HX_("\"",22,00,00,00)));
HXLINE( 512)				return;
            			}
HXLINE( 516)			 ::lime::utils::AssetLibrary library1 = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE( 518)			if (hx::IsNull( library1 )) {
HXLINE( 520)				promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            			}
            			else {
HXLINE( 524)				::lime::utils::Assets_obj::libraries->set(id,library1);
HXLINE( 525)				library1->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 526)				 ::lime::app::Future _hx_tmp = library1->load();
HXDLIN( 526)				promise->completeWith(_hx_tmp);
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_df5754140b017d9f_532_loadLibrary)
HXLINE( 532)			promise->error(((HX_("There is no asset library with an ID of \"",8b,06,e2,9a) + id) + HX_("\"",22,00,00,00)));
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_df5754140b017d9f_479_loadLibrary)
HXLINE( 481)		 ::lime::app::Promise_lime_utils_AssetLibrary promise =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
HXLINE( 485)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(id);
HXLINE( 487)		if (hx::IsNotNull( library )) {
HXLINE( 489)			return library->load();
            		}
HXLINE( 493)		::String path = id;
HXLINE( 494)		::String rootPath = null();
HXLINE( 496)		if (::lime::utils::Assets_obj::libraryPaths->exists(id)) {
HXLINE( 498)			path = ( (::String)(::lime::utils::Assets_obj::libraryPaths->get(id)) );
HXLINE( 499)			rootPath = ::lime::utils::Assets_obj::defaultRootPath;
            		}
            		else {
HXLINE( 501)			if (::StringTools_obj::endsWith(path,HX_(".bundle",30,4a,b8,4e))) {
HXLINE( 503)				path = (path + HX_("/library.json",2a,a7,07,47));
            			}
            		}
HXLINE( 507)		::lime::utils::AssetManifest_obj::loadFromFile(path,rootPath)->onComplete( ::Dynamic(new _hx_Closure_0(id,promise)))->onError( ::Dynamic(new _hx_Closure_1(id,promise)));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,loadLibrary,return )
 ...
 ::lime::app::Future Assets_obj::loadText(::String id){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_545_loadText)
HXDLIN( 545)		return ::lime::utils::Assets_obj::loadAsset(id,HX_("TEXT",ad,94,ba,37),false);
            	}
...
void Assets_obj::registerLibrary(::String name, ::lime::utils::AssetLibrary library){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_550_registerLibrary)
HXLINE( 552)		if (::lime::utils::Assets_obj::libraries->exists(name)) {
HXLINE( 554)			if (hx::IsEq( ::lime::utils::Assets_obj::libraries->get(name).StaticCast<  ::lime::utils::AssetLibrary >(),library )) {
HXLINE( 556)				return;
            			}
            			else {
HXLINE( 560)				::lime::utils::Assets_obj::unloadLibrary(name);
            			}
            		}
HXLINE( 566)		if (hx::IsNotNull( library )) {
HXLINE( 568)			library->onChange->add(::lime::utils::Assets_obj::library_onChange_dyn(),null(),null());
            		}
HXLINE( 572)		::lime::utils::Assets_obj::libraries->set(name,library);
            	}
...
void Assets_obj::unloadLibrary(::String name){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_577_unloadLibrary)
HXLINE( 581)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::libraries->get(name).StaticCast<  ::lime::utils::AssetLibrary >();
HXLINE( 583)		if (hx::IsNotNull( library )) {
HXLINE( 585)			 ::lime::utils::AssetCache _hx_tmp = ::lime::utils::Assets_obj::cache;
HXDLIN( 585)			_hx_tmp->clear((name + HX_(":",3a,00,00,00)));
HXLINE( 586)			library->onChange->remove(::lime::utils::Assets_obj::library_onChange_dyn());
HXLINE( 587)			library->unload();
            		}
HXLINE( 591)		::lime::utils::Assets_obj::libraries->remove(name);
            	}
...
::String Assets_obj::_hx___libraryNotFound(::String name){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_598___libraryNotFound)
HXLINE( 600)		bool _hx_tmp;
HXDLIN( 600)		if (hx::IsNotNull( name )) {
HXLINE( 600)			_hx_tmp = (name == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 600)			_hx_tmp = true;
            		}
HXDLIN( 600)		if (_hx_tmp) {
HXLINE( 602)			name = HX_("default",c1,d8,c3,9b);
            		}
HXLINE( 606)		bool _hx_tmp1;
HXDLIN( 606)		bool _hx_tmp2;
HXDLIN( 606)		if (hx::IsNotNull( ::lime::app::Application_obj::current )) {
HXLINE( 606)			_hx_tmp2 = hx::IsNotNull( ::lime::app::Application_obj::current->_hx___preloader );
            		}
            		else {
HXLINE( 606)			_hx_tmp2 = false;
            		}
HXDLIN( 606)		if (_hx_tmp2) {
HXLINE( 606)			_hx_tmp1 = !(::lime::app::Application_obj::current->_hx___preloader->complete);
            		}
            		else {
HXLINE( 606)			_hx_tmp1 = false;
            		}
HXDLIN( 606)		if (_hx_tmp1) {
HXLINE( 608)			return ((HX_("There is no asset library named \"",a1,83,5f,51) + name) + HX_("\", or it is not yet preloaded",db,ac,d4,2f));
            		}
            		else {
HXLINE( 612)			return ((HX_("There is no asset library named \"",a1,83,5f,51) + name) + HX_("\"",22,00,00,00));
            		}
...
void Assets_obj::library_onChange(){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_626_library_onChange)
HXLINE( 628)		::lime::utils::Assets_obj::cache->clear(null());
HXLINE( 629)		::lime::utils::Assets_obj::onChange->dispatch();
            	}
