...
HX_DEFINE_STACK_FRAME(_hx_pos_315ede9a8526b069_7_new,"lime.graphics.opengl.ext.APPLE_texture_format_BGRA8888","new",0x11d71fa3,"lime.graphics.opengl.ext.APPLE_texture_format_BGRA8888.new","lime/graphics/opengl/ext/APPLE_texture_format_BGRA8888.hx",7,0x566515cf)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void APPLE_texture_format_BGRA8888_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_315ede9a8526b069_7_new)
HXDLIN(   7)		this->BGRA_EXT = (int)32993;
            	}
