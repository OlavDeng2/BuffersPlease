...
HX_DEFINE_STACK_FRAME(_hx_pos_20db0725ba88843e_10_new,"lime.graphics.opengl.ext.OES_standard_derivatives","new",0x79508820,"lime.graphics.opengl.ext.OES_standard_derivatives.new","lime/graphics/opengl/ext/OES_standard_derivatives.hx",10,0x62d66dee)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void OES_standard_derivatives_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_20db0725ba88843e_10_new)
HXDLIN(  10)		this->FRAGMENT_SHADER_DERIVATIVE_HINT_OES = (int)35723;
            	}
