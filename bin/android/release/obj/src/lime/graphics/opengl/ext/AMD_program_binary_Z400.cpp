...
HX_DEFINE_STACK_FRAME(_hx_pos_67064d08ae812aee_7_new,"lime.graphics.opengl.ext.AMD_program_binary_Z400","new",0x8e433f46,"lime.graphics.opengl.ext.AMD_program_binary_Z400.new","lime/graphics/opengl/ext/AMD_program_binary_Z400.hx",7,0x1635f60c)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void AMD_program_binary_Z400_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_67064d08ae812aee_7_new)
HXDLIN(   7)		this->Z400_BINARY_AMD = (int)34624;
            	}
