...
HX_DEFINE_STACK_FRAME(_hx_pos_2b1d0dc1acb0da8b_7_new,"lime.graphics.opengl.ext.OES_vertex_half_float","new",0x752d1419,"lime.graphics.opengl.ext.OES_vertex_half_float.new","lime/graphics/opengl/ext/OES_vertex_half_float.hx",7,0xaf8f7019)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void OES_vertex_half_float_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_2b1d0dc1acb0da8b_7_new)
