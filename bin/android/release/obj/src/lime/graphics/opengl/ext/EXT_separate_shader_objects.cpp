...
HXLINE(  12)		this->PROGRAM_PIPELINE_BINDING_EXT = (int)33370;
HXLINE(  11)		this->ACTIVE_PROGRAM_EXT = (int)33369;
HXLINE(  10)		this->PROGRAM_SEPARABLE_EXT = (int)33368;
HXLINE(   9)		this->ALL_SHADER_BITS_EXT = (int)-1;
HXLINE(   8)		this->FRAGMENT_SHADER_BIT_EXT = (int)2;
HXLINE(   7)		this->VERTEX_SHADER_BIT_EXT = (int)1;
            	}
