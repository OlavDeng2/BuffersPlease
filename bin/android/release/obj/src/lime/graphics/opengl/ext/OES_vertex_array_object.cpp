...
HX_DEFINE_STACK_FRAME(_hx_pos_ff26fc69b0514c16_10_new,"lime.graphics.opengl.ext.OES_vertex_array_object","new",0x554cbf6e,"lime.graphics.opengl.ext.OES_vertex_array_object.new","lime/graphics/opengl/ext/OES_vertex_array_object.hx",10,0xe371b2e4)
HX_LOCAL_STACK_FRAME(_hx_pos_ff26fc69b0514c16_20_createVertexArrayOES,"lime.graphics.opengl.ext.OES_vertex_array_object","createVertexArrayOES",0xc2081f56,"lime.graphics.opengl.ext.OES_vertex_array_object.createVertexArrayOES","lime/graphics/opengl/ext/OES_vertex_array_object.hx",20,0xe371b2e4)
HX_LOCAL_STACK_FRAME(_hx_pos_ff26fc69b0514c16_21_deleteVertexArrayOES,"lime.graphics.opengl.ext.OES_vertex_array_object","deleteVertexArrayOES",0x734d8cc5,"lime.graphics.opengl.ext.OES_vertex_array_object.deleteVertexArrayOES","lime/graphics/opengl/ext/OES_vertex_array_object.hx",21,0xe371b2e4)
HX_LOCAL_STACK_FRAME(_hx_pos_ff26fc69b0514c16_22_isVertexArrayOES,"lime.graphics.opengl.ext.OES_vertex_array_object","isVertexArrayOES",0x250197c4,"lime.graphics.opengl.ext.OES_vertex_array_object.isVertexArrayOES","lime/graphics/opengl/ext/OES_vertex_array_object.hx",22,0xe371b2e4)
...
void OES_vertex_array_object_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_ff26fc69b0514c16_10_new)
HXDLIN(  10)		this->VERTEX_ARRAY_BINDING_OES = (int)34229;
            	}
...
bool OES_vertex_array_object_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic OES_vertex_array_object_obj::createVertexArrayOES(){
            	HX_STACKFRAME(&_hx_pos_ff26fc69b0514c16_20_createVertexArrayOES)
...
void OES_vertex_array_object_obj::deleteVertexArrayOES( ::Dynamic arrayObject){
            	HX_STACKFRAME(&_hx_pos_ff26fc69b0514c16_21_deleteVertexArrayOES)
            	}
...
bool OES_vertex_array_object_obj::isVertexArrayOES( ::Dynamic arrayObject){
            	HX_STACKFRAME(&_hx_pos_ff26fc69b0514c16_22_isVertexArrayOES)
