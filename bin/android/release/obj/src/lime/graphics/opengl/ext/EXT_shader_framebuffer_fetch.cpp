...
HX_DEFINE_STACK_FRAME(_hx_pos_c2a15eaaaac5f681_7_new,"lime.graphics.opengl.ext.EXT_shader_framebuffer_fetch","new",0x36f079a0,"lime.graphics.opengl.ext.EXT_shader_framebuffer_fetch.new","lime/graphics/opengl/ext/EXT_shader_framebuffer_fetch.hx",7,0xe61dd36e)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void EXT_shader_framebuffer_fetch_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c2a15eaaaac5f681_7_new)
HXDLIN(   7)		this->FRAGMENT_SHADER_DISCARDS_SAMPLES_EXT = (int)35410;
            	}
