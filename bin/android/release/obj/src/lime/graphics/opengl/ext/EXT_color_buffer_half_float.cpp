...
HX_DEFINE_STACK_FRAME(_hx_pos_15fbe66fa7b31d40_7_new,"lime.graphics.opengl.ext.EXT_color_buffer_half_float","new",0x4f3c63e5,"lime.graphics.opengl.ext.EXT_color_buffer_half_float.new","lime/graphics/opengl/ext/EXT_color_buffer_half_float.hx",7,0x98cfc34d)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
HXLINE(  19)		this->UNSIGNED_NORMALIZED_EXT = (int)35863;
HXLINE(  18)		this->FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE_EXT = (int)33297;
HXLINE(  15)		this->R16F_EXT = (int)33325;
HXLINE(  14)		this->RG16F_EXT = (int)33327;
HXLINE(  11)		this->RGB16F_EXT = (int)34843;
HXLINE(  10)		this->RGBA16F_EXT = (int)34842;
            	}
