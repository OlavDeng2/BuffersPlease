...
HX_DEFINE_STACK_FRAME(_hx_pos_e1acbdc797cf4fd1_10_new,"lime.graphics.opengl.ext.EXT_shader_texture_lod","new",0xb7c73b55,"lime.graphics.opengl.ext.EXT_shader_texture_lod.new","lime/graphics/opengl/ext/EXT_shader_texture_lod.hx",10,0x940454d9)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void EXT_shader_texture_lod_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e1acbdc797cf4fd1_10_new)
            	}
