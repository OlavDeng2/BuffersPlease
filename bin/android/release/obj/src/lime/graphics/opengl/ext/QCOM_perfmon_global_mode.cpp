...
HX_DEFINE_STACK_FRAME(_hx_pos_8723c151069cfd66_7_new,"lime.graphics.opengl.ext.QCOM_perfmon_global_mode","new",0x76e54308,"lime.graphics.opengl.ext.QCOM_perfmon_global_mode.new","lime/graphics/opengl/ext/QCOM_perfmon_global_mode.hx",7,0x1f188806)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void QCOM_perfmon_global_mode_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_8723c151069cfd66_7_new)
HXDLIN(   7)		this->PERFMON_GLOBAL_MODE_QCOM = (int)36768;
            	}
