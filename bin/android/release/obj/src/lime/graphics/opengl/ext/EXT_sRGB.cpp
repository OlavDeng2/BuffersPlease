...
HX_DEFINE_STACK_FRAME(_hx_pos_36f3917dca2bced0_7_new,"lime.graphics.opengl.ext.EXT_sRGB","new",0x9abd0eac,"lime.graphics.opengl.ext.EXT_sRGB.new","lime/graphics/opengl/ext/EXT_sRGB.hx",7,0x7d9f60e2)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
HXLINE(  13)		this->FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING_EXT = (int)33296;
HXLINE(  12)		this->SRGB8_ALPHA8_EXT = (int)35907;
HXLINE(  11)		this->SRGB_ALPHA_EXT = (int)35906;
HXLINE(  10)		this->SRGB_EXT = (int)35904;
            	}
