...
HXLINE(  29)		this->RG16F_EXT = (int)33327;
HXLINE(  28)		this->R16F_EXT = (int)33325;
HXLINE(  27)		this->RG32F_EXT = (int)33328;
HXLINE(  26)		this->R32F_EXT = (int)33326;
HXLINE(  25)		this->RG8_EXT = (int)33323;
HXLINE(  24)		this->R8_EXT = (int)33321;
HXLINE(  23)		this->BGRA8_EXT = (int)37793;
HXLINE(  22)		this->RGB10_EXT = (int)32850;
HXLINE(  21)		this->RGB10_A2_EXT = (int)32857;
HXLINE(  20)		this->LUMINANCE_ALPHA16F_EXT = (int)34847;
HXLINE(  19)		this->LUMINANCE16F_EXT = (int)34846;
HXLINE(  18)		this->ALPHA16F_EXT = (int)34844;
HXLINE(  17)		this->RGB16F_EXT = (int)34843;
HXLINE(  16)		this->RGBA16F_EXT = (int)34842;
HXLINE(  15)		this->LUMINANCE_ALPHA32F_EXT = (int)34841;
HXLINE(  14)		this->LUMINANCE32F_EXT = (int)34840;
HXLINE(  13)		this->ALPHA32F_EXT = (int)34838;
HXLINE(  12)		this->RGB32F_EXT = (int)34837;
HXLINE(  11)		this->RGBA32F_EXT = (int)34836;
HXLINE(  10)		this->LUMINANCE8_ALPHA8_EXT = (int)32837;
HXLINE(   9)		this->LUMINANCE8_EXT = (int)32832;
HXLINE(   8)		this->ALPHA8_EXT = (int)32828;
HXLINE(   7)		this->TEXTURE_IMMUTABLE_FORMAT_EXT = (int)37167;
            	}
