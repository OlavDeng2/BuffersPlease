...
HX_DEFINE_STACK_FRAME(_hx_pos_e453a9408eead012_7_new,"lime.graphics.opengl.ext.OES_surfaceless_context","new",0x7eb95b04,"lime.graphics.opengl.ext.OES_surfaceless_context.new","lime/graphics/opengl/ext/OES_surfaceless_context.hx",7,0x47811c0e)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void OES_surfaceless_context_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e453a9408eead012_7_new)
HXDLIN(   7)		this->FRAMEBUFFER_UNDEFINED_OES = (int)33305;
            	}
