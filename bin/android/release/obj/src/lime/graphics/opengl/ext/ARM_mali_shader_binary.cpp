...
HX_DEFINE_STACK_FRAME(_hx_pos_e18d77e874350d8f_7_new,"lime.graphics.opengl.ext.ARM_mali_shader_binary","new",0x83002564,"lime.graphics.opengl.ext.ARM_mali_shader_binary.new","lime/graphics/opengl/ext/ARM_mali_shader_binary.hx",7,0xd9cea1aa)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void ARM_mali_shader_binary_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e18d77e874350d8f_7_new)
HXDLIN(   7)		this->MALI_SHADER_BINARY_ARM = (int)36704;
            	}
