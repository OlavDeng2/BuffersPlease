...
HX_DEFINE_STACK_FRAME(_hx_pos_c1c02b5b920f81ba_7_new,"lime.graphics.opengl.ext.ANGLE_pack_reverse_row_order","new",0xf68bfd86,"lime.graphics.opengl.ext.ANGLE_pack_reverse_row_order.new","lime/graphics/opengl/ext/ANGLE_pack_reverse_row_order.hx",7,0xfa7dce48)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void ANGLE_pack_reverse_row_order_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c1c02b5b920f81ba_7_new)
HXDLIN(   7)		this->PACK_REVERSE_ROW_ORDER_ANGLE = (int)37796;
            	}
