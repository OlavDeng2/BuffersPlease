...
HX_DEFINE_STACK_FRAME(_hx_pos_60db2844fe3361da_7_new,"lime.graphics.opengl.ext.EXT_blend_minmax","new",0xd4a71f12,"lime.graphics.opengl.ext.EXT_blend_minmax.new","lime/graphics/opengl/ext/EXT_blend_minmax.hx",7,0x3d88ad3c)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void EXT_blend_minmax_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_60db2844fe3361da_7_new)
HXLINE(  11)		this->MAX_EXT = (int)32776;
HXLINE(  10)		this->MIN_EXT = (int)32775;
            	}
