...
HX_DEFINE_STACK_FRAME(_hx_pos_2eff1332e1dfb34e_7_new,"lime.graphics.opengl.ext.FJ_shader_binary_GCCSO","new",0x76465ff8,"lime.graphics.opengl.ext.FJ_shader_binary_GCCSO.new","lime/graphics/opengl/ext/FJ_shader_binary_GCCSO.hx",7,0x8cd5d596)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void FJ_shader_binary_GCCSO_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_2eff1332e1dfb34e_7_new)
HXDLIN(   7)		this->GCCSO_SHADER_BINARY_FJ = (int)37472;
            	}
