...
HX_DEFINE_STACK_FRAME(_hx_pos_276be14287d0ce94_7_new,"lime.graphics.opengl.ext.ANGLE_translated_shader_source","new",0xe2c2076c,"lime.graphics.opengl.ext.ANGLE_translated_shader_source.new","lime/graphics/opengl/ext/ANGLE_translated_shader_source.hx",7,0xc9ee26a2)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void ANGLE_translated_shader_source_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_276be14287d0ce94_7_new)
HXDLIN(   7)		this->TRANSLATED_SHADER_SOURCE_LENGTH_ANGLE = (int)37792;
            	}
