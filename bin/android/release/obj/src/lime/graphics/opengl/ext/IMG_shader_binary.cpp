...
HX_DEFINE_STACK_FRAME(_hx_pos_43d6216dc32e8c46_7_new,"lime.graphics.opengl.ext.IMG_shader_binary","new",0x94e1730f,"lime.graphics.opengl.ext.IMG_shader_binary.new","lime/graphics/opengl/ext/IMG_shader_binary.hx",7,0x813628e3)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void IMG_shader_binary_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_43d6216dc32e8c46_7_new)
HXDLIN(   7)		this->SGX_BINARY_IMG = (int)35850;
            	}
