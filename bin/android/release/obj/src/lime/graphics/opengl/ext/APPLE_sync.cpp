...
HXLINE(  22)		this->TIMEOUT_IGNORED_APPLE = (int)-1;
HXLINE(  21)		this->SYNC_FLUSH_COMMANDS_BIT_APPLE = (int)1;
HXLINE(  20)		this->WAIT_FAILED_APPLE = (int)37149;
HXLINE(  19)		this->CONDITION_SATISFIED_APPLE = (int)37148;
HXLINE(  18)		this->TIMEOUT_EXPIRED_APPLE = (int)37147;
HXLINE(  17)		this->ALREADY_SIGNALED_APPLE = (int)37146;
HXLINE(  16)		this->SIGNALED_APPLE = (int)37145;
HXLINE(  15)		this->UNSIGNALED_APPLE = (int)37144;
HXLINE(  14)		this->SYNC_GPU_COMMANDS_COMPLETE_APPLE = (int)37143;
HXLINE(  13)		this->SYNC_FENCE_APPLE = (int)37142;
HXLINE(  12)		this->SYNC_FLAGS_APPLE = (int)37141;
HXLINE(  11)		this->SYNC_STATUS_APPLE = (int)37140;
HXLINE(  10)		this->SYNC_CONDITION_APPLE = (int)37139;
HXLINE(   9)		this->OBJECT_TYPE_APPLE = (int)37138;
HXLINE(   8)		this->MAX_SERVER_WAIT_TIMEOUT_APPLE = (int)37137;
HXLINE(   7)		this->SYNC_OBJECT_APPLE = (int)35411;
            	}
