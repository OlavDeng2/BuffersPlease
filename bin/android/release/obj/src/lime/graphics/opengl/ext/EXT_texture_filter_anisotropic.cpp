...
HX_DEFINE_STACK_FRAME(_hx_pos_d977a03d893e508f_7_new,"lime.graphics.opengl.ext.EXT_texture_filter_anisotropic","new",0x0f604e60,"lime.graphics.opengl.ext.EXT_texture_filter_anisotropic.new","lime/graphics/opengl/ext/EXT_texture_filter_anisotropic.hx",7,0x1cc8fa2e)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void EXT_texture_filter_anisotropic_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_d977a03d893e508f_7_new)
HXLINE(  11)		this->MAX_TEXTURE_MAX_ANISOTROPY_EXT = (int)34047;
HXLINE(  10)		this->TEXTURE_MAX_ANISOTROPY_EXT = (int)34046;
            	}
