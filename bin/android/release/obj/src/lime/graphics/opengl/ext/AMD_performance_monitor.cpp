...
HXLINE(  13)		this->PERFMON_RESULT_AMD = (int)35782;
HXLINE(  12)		this->PERFMON_RESULT_SIZE_AMD = (int)35781;
HXLINE(  11)		this->PERFMON_RESULT_AVAILABLE_AMD = (int)35780;
HXLINE(  10)		this->PERCENTAGE_AMD = (int)35779;
HXLINE(   9)		this->UNSIGNED_INT64_AMD = (int)35778;
HXLINE(   8)		this->COUNTER_RANGE_AMD = (int)35777;
HXLINE(   7)		this->COUNTER_TYPE_AMD = (int)35776;
            	}
