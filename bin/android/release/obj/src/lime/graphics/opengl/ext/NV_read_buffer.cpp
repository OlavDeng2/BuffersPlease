...
HX_DEFINE_STACK_FRAME(_hx_pos_7fd5b608eccbd553_7_new,"lime.graphics.opengl.ext.NV_read_buffer","new",0x0be51166,"lime.graphics.opengl.ext.NV_read_buffer.new","lime/graphics/opengl/ext/NV_read_buffer.hx",7,0x21ff5de8)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void NV_read_buffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7fd5b608eccbd553_7_new)
HXDLIN(   7)		this->READ_BUFFER_NV = (int)3074;
            	}
