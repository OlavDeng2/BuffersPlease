...
HX_DEFINE_STACK_FRAME(_hx_pos_ad90b26c872a9ef8_7_new,"lime.graphics.opengl.ext.IMG_program_binary","new",0x8d5e10cc,"lime.graphics.opengl.ext.IMG_program_binary.new","lime/graphics/opengl/ext/IMG_program_binary.hx",7,0xcae1b442)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void IMG_program_binary_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_ad90b26c872a9ef8_7_new)
HXDLIN(   7)		this->SGX_PROGRAM_BINARY_IMG = (int)37168;
            	}
