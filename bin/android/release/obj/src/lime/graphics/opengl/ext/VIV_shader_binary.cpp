...
HX_DEFINE_STACK_FRAME(_hx_pos_4bc70f1cf8ced427_7_new,"lime.graphics.opengl.ext.VIV_shader_binary","new",0xccc744ef,"lime.graphics.opengl.ext.VIV_shader_binary.new","lime/graphics/opengl/ext/VIV_shader_binary.hx",7,0xb3f93303)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void VIV_shader_binary_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4bc70f1cf8ced427_7_new)
HXDLIN(   7)		this->SHADER_BINARY_VIV = (int)36804;
            	}
