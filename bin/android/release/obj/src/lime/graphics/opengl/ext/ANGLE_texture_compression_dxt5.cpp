...
HX_DEFINE_STACK_FRAME(_hx_pos_958283fb81ddd880_7_new,"lime.graphics.opengl.ext.ANGLE_texture_compression_dxt5","new",0xa5f7a412,"lime.graphics.opengl.ext.ANGLE_texture_compression_dxt5.new","lime/graphics/opengl/ext/ANGLE_texture_compression_dxt5.hx",7,0x984b60bc)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void ANGLE_texture_compression_dxt5_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_958283fb81ddd880_7_new)
HXDLIN(   7)		this->COMPRESSED_RGBA_S3TC_DXT5_ANGLE = (int)33779;
            	}
