...
HXLINE(  12)		this->VERTEX_ARRAY_OBJECT_EXT = (int)37204;
HXLINE(  11)		this->QUERY_OBJECT_EXT = (int)37203;
HXLINE(  10)		this->BUFFER_OBJECT_EXT = (int)37201;
HXLINE(   9)		this->SHADER_OBJECT_EXT = (int)35656;
HXLINE(   8)		this->PROGRAM_OBJECT_EXT = (int)35648;
HXLINE(   7)		this->PROGRAM_PIPELINE_OBJECT_EXT = (int)35407;
            	}
