...
HX_DEFINE_STACK_FRAME(_hx_pos_c9ab2221efeb0596_10_new,"lime.graphics.opengl.ext.OES_element_index_uint","new",0xddf74ae0,"lime.graphics.opengl.ext.OES_element_index_uint.new","lime/graphics/opengl/ext/OES_element_index_uint.hx",10,0x4991bfae)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void OES_element_index_uint_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c9ab2221efeb0596_10_new)
HXDLIN(  10)		this->UNSIGNED_INT = (int)5125;
            	}
