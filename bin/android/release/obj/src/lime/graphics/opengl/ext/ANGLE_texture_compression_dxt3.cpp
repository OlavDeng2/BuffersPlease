...
HX_DEFINE_STACK_FRAME(_hx_pos_b30108ea6b58727c_7_new,"lime.graphics.opengl.ext.ANGLE_texture_compression_dxt3","new",0x7f2a7b10,"lime.graphics.opengl.ext.ANGLE_texture_compression_dxt3.new","lime/graphics/opengl/ext/ANGLE_texture_compression_dxt3.hx",7,0x96f8f37e)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void ANGLE_texture_compression_dxt3_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b30108ea6b58727c_7_new)
HXDLIN(   7)		this->COMPRESSED_RGBA_S3TC_DXT3_ANGLE = (int)33778;
            	}
