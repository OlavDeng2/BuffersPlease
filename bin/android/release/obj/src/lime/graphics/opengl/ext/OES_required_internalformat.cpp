...
HXLINE(  20)		this->RGB10_EXT = (int)32850;
HXLINE(  19)		this->RGBA8_OES = (int)32856;
HXLINE(  18)		this->RGB8_OES = (int)32849;
HXLINE(  17)		this->RGB565_OES = (int)36194;
HXLINE(  16)		this->RGB5_A1_OES = (int)32855;
HXLINE(  15)		this->RGBA4_OES = (int)32854;
HXLINE(  14)		this->LUMINANCE8_OES = (int)32832;
HXLINE(  13)		this->LUMINANCE8_ALPHA8_OES = (int)32837;
HXLINE(  12)		this->LUMINANCE4_ALPHA4_OES = (int)32835;
HXLINE(  11)		this->DEPTH_COMPONENT32_OES = (int)33191;
HXLINE(  10)		this->DEPTH24_STENCIL8_OES = (int)35056;
HXLINE(   9)		this->DEPTH_COMPONENT24_OES = (int)33190;
HXLINE(   8)		this->DEPTH_COMPONENT16_OES = (int)33189;
HXLINE(   7)		this->ALPHA8_OES = (int)32828;
            	}
