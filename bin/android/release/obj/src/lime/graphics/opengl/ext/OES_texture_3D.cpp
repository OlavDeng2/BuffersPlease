...
HXLINE(  12)		this->FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_OES = (int)36052;
HXLINE(  11)		this->SAMPLER_3D_OES = (int)35679;
HXLINE(  10)		this->MAX_3D_TEXTURE_SIZE_OES = (int)32883;
HXLINE(   9)		this->TEXTURE_BINDING_3D_OES = (int)32874;
HXLINE(   8)		this->TEXTURE_3D_OES = (int)32879;
HXLINE(   7)		this->TEXTURE_WRAP_R_OES = (int)32882;
            	}
