...
HX_DEFINE_STACK_FRAME(_hx_pos_20c611465b484b2c_7_new,"lime.graphics.opengl.ext.DMP_shader_binary","new",0xc9fe28d3,"lime.graphics.opengl.ext.DMP_shader_binary.new","lime/graphics/opengl/ext/DMP_shader_binary.hx",7,0x26c2579f)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void DMP_shader_binary_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_20c611465b484b2c_7_new)
HXDLIN(   7)		this->SHADER_BINARY_DMP = (int)37456;
            	}
