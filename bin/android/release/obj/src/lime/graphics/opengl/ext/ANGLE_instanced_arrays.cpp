...
HX_DEFINE_STACK_FRAME(_hx_pos_b3b5b227d74e9109_10_new,"lime.graphics.opengl.ext.ANGLE_instanced_arrays","new",0x4559516a,"lime.graphics.opengl.ext.ANGLE_instanced_arrays.new","lime/graphics/opengl/ext/ANGLE_instanced_arrays.hx",10,0x2d555864)
HX_LOCAL_STACK_FRAME(_hx_pos_b3b5b227d74e9109_25_drawArraysInstancedANGLE,"lime.graphics.opengl.ext.ANGLE_instanced_arrays","drawArraysInstancedANGLE",0xb2062558,"lime.graphics.opengl.ext.ANGLE_instanced_arrays.drawArraysInstancedANGLE","lime/graphics/opengl/ext/ANGLE_instanced_arrays.hx",25,0x2d555864)
HX_LOCAL_STACK_FRAME(_hx_pos_b3b5b227d74e9109_26_drawElementsInstancedANGLE,"lime.graphics.opengl.ext.ANGLE_instanced_arrays","drawElementsInstancedANGLE",0x203b0e15,"lime.graphics.opengl.ext.ANGLE_instanced_arrays.drawElementsInstancedANGLE","lime/graphics/opengl/ext/ANGLE_instanced_arrays.hx",26,0x2d555864)
HX_LOCAL_STACK_FRAME(_hx_pos_b3b5b227d74e9109_27_vertexAttribDivisorANGLE,"lime.graphics.opengl.ext.ANGLE_instanced_arrays","vertexAttribDivisorANGLE",0x66bdeb39,"lime.graphics.opengl.ext.ANGLE_instanced_arrays.vertexAttribDivisorANGLE","lime/graphics/opengl/ext/ANGLE_instanced_arrays.hx",27,0x2d555864)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void ANGLE_instanced_arrays_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b3b5b227d74e9109_10_new)
HXDLIN(  10)		this->VERTEX_ATTRIB_ARRAY_DIVISOR_ANGLE = (int)35070;
            	}
...
void ANGLE_instanced_arrays_obj::drawArraysInstancedANGLE(int mode,int first,int count,int primcount){
            	HX_STACKFRAME(&_hx_pos_b3b5b227d74e9109_25_drawArraysInstancedANGLE)
            	}
...
void ANGLE_instanced_arrays_obj::drawElementsInstancedANGLE(int mode,int count,int type,int offset,int primcount){
            	HX_STACKFRAME(&_hx_pos_b3b5b227d74e9109_26_drawElementsInstancedANGLE)
            	}
...
void ANGLE_instanced_arrays_obj::vertexAttribDivisorANGLE(int index,int divisor){
            	HX_STACKFRAME(&_hx_pos_b3b5b227d74e9109_27_vertexAttribDivisorANGLE)
            	}
