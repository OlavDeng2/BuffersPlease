...
HX_DEFINE_STACK_FRAME(_hx_pos_e7d829e633ebb4ac_10_new,"lime.graphics.opengl.ext.OES_texture_half_float","new",0xc8becfca,"lime.graphics.opengl.ext.OES_texture_half_float.new","lime/graphics/opengl/ext/OES_texture_half_float.hx",10,0x6d0fc604)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void OES_texture_half_float_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e7d829e633ebb4ac_10_new)
HXDLIN(  10)		this->HALF_FLOAT_OES = (int)36193;
            	}
