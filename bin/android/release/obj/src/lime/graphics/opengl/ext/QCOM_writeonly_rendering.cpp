...
HX_DEFINE_STACK_FRAME(_hx_pos_e1536ec9c60761cf_7_new,"lime.graphics.opengl.ext.QCOM_writeonly_rendering","new",0x32a4831d,"lime.graphics.opengl.ext.QCOM_writeonly_rendering.new","lime/graphics/opengl/ext/QCOM_writeonly_rendering.hx",7,0x4b8fa191)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void QCOM_writeonly_rendering_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e1536ec9c60761cf_7_new)
HXDLIN(   7)		this->WRITEONLY_RENDERING_QCOM = (int)34851;
            	}
