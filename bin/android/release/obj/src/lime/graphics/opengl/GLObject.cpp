...
HX_DEFINE_STACK_FRAME(_hx_pos_def54b8cacb52d8e_3045_new,"lime.graphics.opengl.GLObject","new",0x33d200eb,"lime.graphics.opengl.GLObject.new","lime/graphics/opengl/GL.hx",3045,0xa5aa2623)
HX_LOCAL_STACK_FRAME(_hx_pos_def54b8cacb52d8e_3050_fromInt,"lime.graphics.opengl.GLObject","fromInt",0x6703afb0,"lime.graphics.opengl.GLObject.fromInt","lime/graphics/opengl/GL.hx",3050,0xa5aa2623)
namespace lime{
namespace graphics{
namespace opengl{

void GLObject_obj::__construct(int id){
            	HX_STACKFRAME(&_hx_pos_def54b8cacb52d8e_3045_new)
HXDLIN(3045)		this->id = id;
            	}
...
bool GLObject_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLObject_obj::fromInt(int type,int id){
            	HX_GC_STACKFRAME(&_hx_pos_def54b8cacb52d8e_3050_fromInt)
HXLINE(3052)		if ((id == (int)0)) {
HXLINE(3052)			return null();
            		}
HXLINE(3055)		 ::hx::Object * object = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_object_from_id(id,type);
HXLINE(3057)		if (hx::IsNotEq( object,hx::DynamicPtr(null()) )) {
HXLINE(3059)			return ( ( ::Dynamic)(object) );
            		}
HXLINE(3063)		object = hx::DynamicPtr( ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id));
HXLINE(3064)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_object_register(id,type,object);
HXLINE(3065)		return ( ( ::Dynamic)(object) );
            	}
