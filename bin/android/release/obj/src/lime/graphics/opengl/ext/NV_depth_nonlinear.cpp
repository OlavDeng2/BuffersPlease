...
HX_DEFINE_STACK_FRAME(_hx_pos_651bef4d6f261626_7_new,"lime.graphics.opengl.ext.NV_depth_nonlinear","new",0x7b262493,"lime.graphics.opengl.ext.NV_depth_nonlinear.new","lime/graphics/opengl/ext/NV_depth_nonlinear.hx",7,0x26a3765b)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void NV_depth_nonlinear_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_651bef4d6f261626_7_new)
HXDLIN(   7)		this->DEPTH_COMPONENT16_NONLINEAR_NV = (int)36396;
            	}
