...
HX_DEFINE_STACK_FRAME(_hx_pos_2b1cc31c43c675de_7_new,"lime.graphics.opengl.ext.APPLE_texture_max_level","new",0xb41c1cd0,"lime.graphics.opengl.ext.APPLE_texture_max_level.new","lime/graphics/opengl/ext/APPLE_texture_max_level.hx",7,0x1e6a97c2)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void APPLE_texture_max_level_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_2b1cc31c43c675de_7_new)
HXDLIN(   7)		this->TEXTURE_MAX_LEVEL_APPLE = (int)33085;
            	}
