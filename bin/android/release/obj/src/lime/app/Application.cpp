...
HX_LOCAL_STACK_FRAME(_hx_pos_aca430172aa84436_55___init__,"::lime::app::Application_obj","__init__",0x5d7d4402,"::lime::app::Application_obj.__init__","lime/app/Application.hx",55,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_84_addModule,"lime.app.Application","addModule",0x673258c9,"lime.app.Application.addModule","lime/app/Application.hx",84,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_119_addRenderer,"lime.app.Application","addRenderer",0x0a61eaa0,"lime.app.Application.addRenderer","lime/app/Application.hx",119,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_138_create,"lime.app.Application","create",0x35e42e60,"lime.app.Application.create","lime/app/Application.hx",138,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_189_createWindow,"lime.app.Application","createWindow",0xb3683e70,"lime.app.Application.createWindow","lime/app/Application.hx",189,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_221_exec,"lime.app.Application","exec",0x508159f5,"lime.app.Application.exec","lime/app/Application.hx",221,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_232_onModuleExit,"lime.app.Application","onModuleExit",0x4a2a2a4d,"lime.app.Application.onModuleExit","lime/app/Application.hx",232,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_239_onWindowClose,"lime.app.Application","onWindowClose",0x133677e5,"lime.app.Application.onWindowClose","lime/app/Application.hx",239,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_250_removeModule,"lime.app.Application","removeModule",0x6e873a74,"lime.app.Application.removeModule","lime/app/Application.hx",250,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_262_removeWindow,"lime.app.Application","removeWindow",0x004099b8,"lime.app.Application.removeWindow","lime/app/Application.hx",262,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_291_setPreloader,"lime.app.Application","setPreloader",0xe5520ed8,"lime.app.Application.setPreloader","lime/app/Application.hx",291,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_313_get_frameRate,"lime.app.Application","get_frameRate",0x719f92a0,"lime.app.Application.get_frameRate","lime/app/Application.hx",313,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_320_set_frameRate,"lime.app.Application","set_frameRate",0xb6a574ac,"lime.app.Application.set_frameRate","lime/app/Application.hx",320,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_327_get_preloader,"lime.app.Application","get_preloader",0xbaf66569,"lime.app.Application.get_preloader","lime/app/Application.hx",327,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_334_get_renderer,"lime.app.Application","get_renderer",0xa67be3b0,"lime.app.Application.get_renderer","lime/app/Application.hx",334,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_341_get_renderers,"lime.app.Application","get_renderers",0x05eb56c3,"lime.app.Application.get_renderers","lime/app/Application.hx",341,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_348_get_window,"lime.app.Application","get_window",0xc86a4d1d,"lime.app.Application.get_window","lime/app/Application.hx",348,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_355_get_windows,"lime.app.Application","get_windows",0x94992cb6,"lime.app.Application.get_windows","lime/app/Application.hx",355,0x8bc55476)
namespace lime{
namespace app{
...
HXLINE(  64)		if (hx::IsNull( ::lime::app::Application_obj::current )) {
HXLINE(  66)			::lime::app::Application_obj::current = hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE(  70)		this->modules = ::Array_obj< ::Dynamic>::__new();
HXLINE(  71)		this->windowByID =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  73)		this->backend =  ::lime::_backend::native::NativeApplication_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
HXLINE(  75)		this->registerModule(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Application_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_aca430172aa84436_55___init__)
HXDLIN(  55)		 ::Dynamic init = hx::ClassOf< ::lime::_backend::native::NativeApplication >();
            	}


void Application_obj::addModule(::Dynamic module){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_84_addModule)
HXLINE(  86)		::lime::app::IModule_obj::registerModule(module,hx::ObjectPtr<OBJ_>(this));
HXLINE(  87)		this->modules->push(module);
HXLINE(  89)		if ((this->_hx___renderers->length > (int)0)) {
HXLINE(  91)			int _g = (int)0;
HXDLIN(  91)			::Array< ::Dynamic> _g1 = this->_hx___renderers;
HXDLIN(  91)			while((_g < _g1->length)){
HXLINE(  91)				 ::lime::graphics::Renderer renderer = _g1->__get(_g).StaticCast<  ::lime::graphics::Renderer >();
HXDLIN(  91)				_g = (_g + (int)1);
HXLINE(  93)				::lime::app::IModule_obj::addRenderer(module,renderer);
            			}
            		}
HXLINE(  99)		if ((this->_hx___windows->length > (int)0)) {
HXLINE( 101)			int _g2 = (int)0;
HXDLIN( 101)			::Array< ::Dynamic> _g11 = this->_hx___windows;
HXDLIN( 101)			while((_g2 < _g11->length)){
HXLINE( 101)				 ::lime::ui::Window window = _g11->__get(_g2).StaticCast<  ::lime::ui::Window >();
HXDLIN( 101)				_g2 = (_g2 + (int)1);
HXLINE( 103)				::lime::app::IModule_obj::addWindow(module,window);
            			}
            		}
HXLINE( 109)		::lime::app::IModule_obj::setPreloader(module,this->_hx___preloader);
            	}
...
void Application_obj::addRenderer( ::lime::graphics::Renderer renderer){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_119_addRenderer)
HXLINE( 121)		this->super::addRenderer(renderer);
HXLINE( 123)		{
HXLINE( 123)			int _g = (int)0;
HXDLIN( 123)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 123)			while((_g < _g1->length)){
HXLINE( 123)				::Dynamic module = _g1->__get(_g);
HXDLIN( 123)				_g = (_g + (int)1);
HXLINE( 125)				::lime::app::IModule_obj::addRenderer(module,renderer);
            			}
            		}
            	}
...
void Application_obj::create( ::Dynamic config){
            	HX_GC_STACKFRAME(&_hx_pos_da4fb7bee4c62773_138_create)
HXLINE( 140)		this->config = config;
HXLINE( 142)		this->backend->create(config);
HXLINE( 144)		if (hx::IsNotNull( config )) {
HXLINE( 146)			if (::Reflect_obj::hasField(config,HX_("fps",e9,c7,4d,00))) {
HXLINE( 148)				this->backend->setFrameRate(( (Float)(config->__Field(HX_("fps",e9,c7,4d,00),hx::paccDynamic)) ));
            			}
HXLINE( 152)			if (::Reflect_obj::hasField(config,HX_("windows",83,de,74,e8))) {
HXLINE( 154)				int _g = (int)0;
HXDLIN( 154)				::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic)) );
HXDLIN( 154)				while((_g < _g1->length)){
HXLINE( 154)					 ::Dynamic windowConfig = _g1->__get(_g);
HXDLIN( 154)					_g = (_g + (int)1);
HXLINE( 156)					 ::lime::ui::Window window =  ::lime::ui::Window_obj::__alloc( HX_CTX ,windowConfig);
HXLINE( 157)					this->createWindow(window);
            				}
            			}
HXLINE( 167)			bool _hx_tmp;
HXDLIN( 167)			if (hx::IsNotNull( this->_hx___preloader )) {
HXLINE( 167)				_hx_tmp = this->_hx___preloader->complete;
            			}
            			else {
HXLINE( 167)				_hx_tmp = true;
            			}
HXDLIN( 167)			if (_hx_tmp) {
HXLINE( 169)				this->setPreloader(this->_hx___preloader);
HXLINE( 171)				{
HXLINE( 171)					int _g2 = (int)0;
HXDLIN( 171)					::Array< ::Dynamic> _g11 = this->modules;
HXDLIN( 171)					while((_g2 < _g11->length)){
HXLINE( 171)						::Dynamic module = _g11->__get(_g2);
HXDLIN( 171)						_g2 = (_g2 + (int)1);
HXLINE( 173)						this->setPreloader(this->_hx___preloader);
            					}
            				}
            			}
            		}
...
void Application_obj::createWindow( ::lime::ui::Window window){
            	HX_GC_STACKFRAME(&_hx_pos_da4fb7bee4c62773_189_createWindow)
HXLINE( 191)		this->super::addWindow(window);
HXLINE( 193)		{
HXLINE( 193)			int _g = (int)0;
HXDLIN( 193)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 193)			while((_g < _g1->length)){
HXLINE( 193)				::Dynamic module = _g1->__get(_g);
HXDLIN( 193)				_g = (_g + (int)1);
HXLINE( 195)				::lime::app::IModule_obj::addWindow(module,window);
            			}
            		}
HXLINE( 199)		if (hx::IsNull( window->renderer )) {
HXLINE( 201)			 ::lime::graphics::Renderer renderer =  ::lime::graphics::Renderer_obj::__alloc( HX_CTX ,window);
HXLINE( 202)			this->addRenderer(renderer);
            		}
HXLINE( 206)		window->create(hx::ObjectPtr<OBJ_>(this));
HXLINE( 208)		this->windowByID->set(window->id,window);
HXLINE( 210)		window->onCreate->dispatch();
            	}
...
int Application_obj::exec(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_221_exec)
HXLINE( 223)		::lime::app::Application_obj::current = hx::ObjectPtr<OBJ_>(this);
HXLINE( 225)		return this->backend->exec();
            	}
...
void Application_obj::onModuleExit(int code){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_232_onModuleExit)
HXDLIN( 232)		this->backend->exit();
            	}


void Application_obj::onWindowClose( ::lime::ui::Window window){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_239_onWindowClose)
HXDLIN( 239)		this->removeWindow(window);
            	}


void Application_obj::removeModule(::Dynamic module){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_250_removeModule)
HXDLIN( 250)		if (hx::IsNotNull( module )) {
HXLINE( 252)			::lime::app::IModule_obj::unregisterModule(module,hx::ObjectPtr<OBJ_>(this));
HXLINE( 253)			this->modules->remove(module);
            		}
            	}
...
void Application_obj::removeWindow( ::lime::ui::Window window){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_262_removeWindow)
HXDLIN( 262)		bool _hx_tmp;
HXDLIN( 262)		if (hx::IsNotNull( window )) {
HXDLIN( 262)			_hx_tmp = this->windowByID->exists(window->id);
            		}
            		else {
HXDLIN( 262)			_hx_tmp = false;
            		}
HXDLIN( 262)		if (_hx_tmp) {
HXLINE( 264)			this->_hx___windows->remove(window);
HXLINE( 265)			this->windowByID->remove(window->id);
HXLINE( 266)			window->close();
HXLINE( 268)			if (hx::IsNotNull( window->renderer )) {
HXLINE( 270)				this->removeRenderer(window->renderer);
            			}
HXLINE( 274)			if (hx::IsEq( this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >(),window )) {
HXLINE( 276)				this->window = null();
            			}
HXLINE( 280)			if ((this->_hx___windows->length == (int)0)) {
HXLINE( 282)				::lime::_hx_system::System_obj::exit((int)0);
            			}
            		}
            	}
...
void Application_obj::setPreloader( ::lime::app::Preloader preloader){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_291_setPreloader)
HXLINE( 293)		this->super::setPreloader(preloader);
HXLINE( 295)		{
HXLINE( 295)			int _g = (int)0;
HXDLIN( 295)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 295)			while((_g < _g1->length)){
HXLINE( 295)				::Dynamic module = _g1->__get(_g);
HXDLIN( 295)				_g = (_g + (int)1);
HXLINE( 297)				::lime::app::IModule_obj::setPreloader(module,preloader);
            			}
            		}
            	}
...
Float Application_obj::get_frameRate(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_313_get_frameRate)
HXDLIN( 313)		return this->backend->getFrameRate();
            	}
...
Float Application_obj::set_frameRate(Float value){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_320_set_frameRate)
HXDLIN( 320)		return this->backend->setFrameRate(value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Application_obj,set_frameRate,return )
 ...
 ::lime::app::Preloader Application_obj::get_preloader(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_327_get_preloader)
HXDLIN( 327)		return this->_hx___preloader;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_preloader,return )
 ...
 ::lime::graphics::Renderer Application_obj::get_renderer(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_334_get_renderer)
HXDLIN( 334)		return this->_hx___renderers->__get((int)0).StaticCast<  ::lime::graphics::Renderer >();
            	}
...
::Array< ::Dynamic> Application_obj::get_renderers(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_341_get_renderers)
HXDLIN( 341)		return this->_hx___renderers;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_renderers,return )
 ...
 ::lime::ui::Window Application_obj::get_window(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_348_get_window)
HXDLIN( 348)		return this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >();
            	}
...
::Array< ::Dynamic> Application_obj::get_windows(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_355_get_windows)
HXDLIN( 355)		return this->_hx___windows;
            	}
