...
HX_LOCAL_STACK_FRAME(_hx_pos_31224ac778a9eff4_876_fromBytes,"lime.net._HTTPRequest_lime_graphics_Image","fromBytes",0xef825737,"lime.net._HTTPRequest_lime_graphics_Image.fromBytes","lime/graphics/Image.hx",876,0xc7b862ad)
namespace lime{
namespace net{
...
bool _HTTPRequest_lime_graphics_Image_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_lime_graphics_Image_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_31224ac778a9eff4_876_fromBytes)
HXDLIN( 876)		return ::lime::graphics::Image_obj::fromBytes(bytes);
            	}
