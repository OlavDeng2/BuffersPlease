...
HXDLIN( 101)		 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
...
HXDLIN( 112)		 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
...
HXDLIN( 123)		 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
...
HXDLIN( 156)		if ((this->_hx___workQueued > this->_hx___workCompleted)) {
