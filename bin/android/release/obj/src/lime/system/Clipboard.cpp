...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_59_set_text,"lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",59,0x9490b5ee)
namespace lime{
...
HXDLIN(  42)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_clipboard_get_text()) );
            	}
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_59_set_text)
HXLINE(  62)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_clipboard_set_text(value);
