...
HX_LOCAL_STACK_FRAME(_hx_pos_7fb49d574da4e22e_520_setPosition,"lime._backend.native.NativeAudioSource","setPosition",0xf0034120,"lime._backend.native.NativeAudioSource.setPosition","lime/_backend/native/NativeAudioSource.hx",520,0xbddaa99c)
...
HXLINE( 511)		::Array< Float > value = ::lime::media::openal::AL_obj::getSource3f(this->handle,(int)4100);
HXLINE( 512)		this->position->x = value->__get((int)0);
HXLINE( 513)		this->position->y = value->__get((int)1);
HXLINE( 514)		this->position->z = value->__get((int)2);
HXLINE( 515)		return this->position;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeAudioSource_obj,getPosition,return )
 ...
 ::lime::math::Vector4 NativeAudioSource_obj::setPosition( ::lime::math::Vector4 value){
            	HX_STACKFRAME(&_hx_pos_7fb49d574da4e22e_520_setPosition)
HXLINE( 522)		this->position->x = value->x;
HXLINE( 523)		this->position->y = value->y;
HXLINE( 524)		this->position->z = value->z;
HXLINE( 525)		this->position->w = value->w;
HXLINE( 527)		::lime::media::openal::AL_obj::distanceModel((int)0);
HXLINE( 528)		::lime::media::openal::AL_obj::source3f(this->handle,(int)4100,this->position->x,this->position->y,this->position->z);
HXLINE( 530)		return this->position;
            	}
