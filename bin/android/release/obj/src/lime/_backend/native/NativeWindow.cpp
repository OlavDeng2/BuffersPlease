...
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_152_focus,"lime._backend.native.NativeWindow","focus",0xe08a6f48,"lime._backend.native.NativeWindow.focus","lime/_backend/native/NativeWindow.hx",152,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_163_getDisplay,"lime._backend.native.NativeWindow","getDisplay",0x2d6caadc,"lime._backend.native.NativeWindow.getDisplay","lime/_backend/native/NativeWindow.hx",163,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_184_getDisplayMode,"lime._backend.native.NativeWindow","getDisplayMode",0x516b485f,"lime._backend.native.NativeWindow.getDisplayMode","lime/_backend/native/NativeWindow.hx",184,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_203_setDisplayMode,"lime._backend.native.NativeWindow","setDisplayMode",0x718b30d3,"lime._backend.native.NativeWindow.setDisplayMode","lime/_backend/native/NativeWindow.hx",203,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_222_getEnableTextEvents,"lime._backend.native.NativeWindow","getEnableTextEvents",0x8c63802f,"lime._backend.native.NativeWindow.getEnableTextEvents","lime/_backend/native/NativeWindow.hx",222,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_239_move,"lime._backend.native.NativeWindow","move",0x8d1891a1,"lime._backend.native.NativeWindow.move","lime/_backend/native/NativeWindow.hx",239,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_252_resize,"lime._backend.native.NativeWindow","resize",0xad67cc84,"lime._backend.native.NativeWindow.resize","lime/_backend/native/NativeWindow.hx",252,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_263_setBorderless,"lime._backend.native.NativeWindow","setBorderless",0x6caf83f7,"lime._backend.native.NativeWindow.setBorderless","lime/_backend/native/NativeWindow.hx",263,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_277_setEnableTextEvents,"lime._backend.native.NativeWindow","setEnableTextEvents",0xc900733b,"lime._backend.native.NativeWindow.setEnableTextEvents","lime/_backend/native/NativeWindow.hx",277,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_292_setFullscreen,"lime._backend.native.NativeWindow","setFullscreen",0x4ef277ed,"lime._backend.native.NativeWindow.setFullscreen","lime/_backend/native/NativeWindow.hx",292,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_320_setIcon,"lime._backend.native.NativeWindow","setIcon",0xb52ef3ab,"lime._backend.native.NativeWindow.setIcon","lime/_backend/native/NativeWindow.hx",320,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_331_setMaximized,"lime._backend.native.NativeWindow","setMaximized",0x34118ca6,"lime._backend.native.NativeWindow.setMaximized","lime/_backend/native/NativeWindow.hx",331,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_346_setMinimized,"lime._backend.native.NativeWindow","setMinimized",0x5dce7a14,"lime._backend.native.NativeWindow.setMinimized","lime/_backend/native/NativeWindow.hx",346,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_361_setResizable,"lime._backend.native.NativeWindow","setResizable",0xde80b5f9,"lime._backend.native.NativeWindow.setResizable","lime/_backend/native/NativeWindow.hx",361,0x34b7ce9f)
HX_LOCAL_STACK_FRAME(_hx_pos_fe3f835f12a28e22_380_setTitle,"lime._backend.native.NativeWindow","setTitle",0x2d49b526,"lime._backend.native.NativeWindow.setTitle","lime/_backend/native/NativeWindow.hx",380,0x34b7ce9f)
namespace lime{
namespace _backend{
namespace native{
...
HXLINE( 134)		this->handle = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_create(hx::DynamicPtr(application->backend->handle),this->parent->_hx___width,this->parent->_hx___height,flags,title)) );
HXLINE( 136)		if (hx::IsNotNull( this->handle )) {
HXLINE( 138)			int _hx_tmp9 = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_width(hx::DynamicPtr(this->handle));
HXDLIN( 138)			this->parent->_hx___width = _hx_tmp9;
HXLINE( 139)			int _hx_tmp10 = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_height(hx::DynamicPtr(this->handle));
HXDLIN( 139)			this->parent->_hx___height = _hx_tmp10;
HXLINE( 140)			int _hx_tmp11 = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_x(hx::DynamicPtr(this->handle));
HXDLIN( 140)			this->parent->_hx___x = _hx_tmp11;
HXLINE( 141)			int _hx_tmp12 = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_y(hx::DynamicPtr(this->handle));
HXDLIN( 141)			this->parent->_hx___y = _hx_tmp12;
HXLINE( 142)			int _hx_tmp13 = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_id(hx::DynamicPtr(this->handle));
HXDLIN( 142)			this->parent->id = _hx_tmp13;
            		}
            	}
...
void NativeWindow_obj::focus(){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_152_focus)
HXDLIN( 152)		if (hx::IsNotNull( this->handle )) {
HXLINE( 155)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_focus(hx::DynamicPtr(this->handle));
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeWindow_obj,focus,(void))
 ...
 ::lime::_hx_system::Display NativeWindow_obj::getDisplay(){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_163_getDisplay)
HXLINE( 165)		if (hx::IsNotNull( this->handle )) {
HXLINE( 168)			int index = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_display(hx::DynamicPtr(this->handle));
HXLINE( 170)			if ((index > (int)-1)) {
HXLINE( 172)				return ::lime::_hx_system::System_obj::getDisplay(index);
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeWindow_obj,getDisplay,return )
 ...
 ::lime::_hx_system::DisplayMode NativeWindow_obj::getDisplayMode(){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_184_getDisplayMode)
HXLINE( 186)		if (hx::IsNotNull( this->handle )) {
HXLINE( 189)			 ::Dynamic data = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_display_mode(hx::DynamicPtr(this->handle))) );
HXLINE( 190)			this->displayMode->width = ( (int)(data->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) );
HXLINE( 191)			this->displayMode->height = ( (int)(data->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) );
HXLINE( 192)			this->displayMode->pixelFormat = ( (int)(data->__Field(HX_("pixelFormat",5d,72,1b,6f),hx::paccDynamic)) );
HXLINE( 193)			this->displayMode->refreshRate = ( (int)(data->__Field(HX_("refreshRate",5b,e2,3f,40),hx::paccDynamic)) );
            		}
HXLINE( 198)		return this->displayMode;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeWindow_obj,getDisplayMode,return )
 ...
 ::lime::_hx_system::DisplayMode NativeWindow_obj::setDisplayMode( ::lime::_hx_system::DisplayMode value){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_203_setDisplayMode)
HXLINE( 205)		if (hx::IsNotNull( this->handle )) {
HXLINE( 208)			 ::Dynamic data = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_display_mode(hx::DynamicPtr(this->handle),hx::DynamicPtr(value))) );
HXLINE( 209)			this->displayMode->width = ( (int)(data->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) );
HXLINE( 210)			this->displayMode->height = ( (int)(data->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) );
HXLINE( 211)			this->displayMode->pixelFormat = ( (int)(data->__Field(HX_("pixelFormat",5d,72,1b,6f),hx::paccDynamic)) );
HXLINE( 212)			this->displayMode->refreshRate = ( (int)(data->__Field(HX_("refreshRate",5b,e2,3f,40),hx::paccDynamic)) );
            		}
HXLINE( 217)		return this->displayMode;
            	}
...
bool NativeWindow_obj::getEnableTextEvents(){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_222_getEnableTextEvents)
HXLINE( 224)		if (hx::IsNotNull( this->handle )) {
HXLINE( 227)			return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_enable_text_events(hx::DynamicPtr(this->handle));
            		}
...
void NativeWindow_obj::move(int x,int y){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_239_move)
HXDLIN( 239)		if (hx::IsNotNull( this->handle )) {
HXLINE( 242)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_move(hx::DynamicPtr(this->handle),x,y);
            		}
            	}
...
void NativeWindow_obj::resize(int width,int height){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_252_resize)
HXDLIN( 252)		if (hx::IsNotNull( this->handle )) {
HXLINE( 255)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_resize(hx::DynamicPtr(this->handle),width,height);
            		}
            	}
...
bool NativeWindow_obj::setBorderless(bool value){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_263_setBorderless)
HXLINE( 265)		if (hx::IsNotNull( this->handle )) {
HXLINE( 268)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_borderless(hx::DynamicPtr(this->handle),value);
            		}
...
bool NativeWindow_obj::setEnableTextEvents(bool value){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_277_setEnableTextEvents)
HXLINE( 279)		if (hx::IsNotNull( this->handle )) {
HXLINE( 282)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_enable_text_events(hx::DynamicPtr(this->handle),value);
            		}
...
bool NativeWindow_obj::setFullscreen(bool value){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_292_setFullscreen)
HXLINE( 294)		if (hx::IsNotNull( this->handle )) {
HXLINE( 297)			value = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_fullscreen(hx::DynamicPtr(this->handle),value);
HXLINE( 299)			int _hx_tmp = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_width(hx::DynamicPtr(this->handle));
HXDLIN( 299)			this->parent->_hx___width = _hx_tmp;
HXLINE( 300)			int _hx_tmp1 = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_height(hx::DynamicPtr(this->handle));
HXDLIN( 300)			this->parent->_hx___height = _hx_tmp1;
HXLINE( 301)			int _hx_tmp2 = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_x(hx::DynamicPtr(this->handle));
HXDLIN( 301)			this->parent->_hx___x = _hx_tmp2;
HXLINE( 302)			int _hx_tmp3 = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_get_y(hx::DynamicPtr(this->handle));
HXDLIN( 302)			this->parent->_hx___y = _hx_tmp3;
HXLINE( 305)			if (value) {
HXLINE( 307)				this->parent->onFullscreen->dispatch();
            			}
            		}
...
void NativeWindow_obj::setIcon( ::lime::graphics::Image image){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_320_setIcon)
HXDLIN( 320)		if (hx::IsNotNull( this->handle )) {
HXLINE( 323)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_icon(hx::DynamicPtr(this->handle),hx::DynamicPtr(image->buffer));
            		}
            	}
...
bool NativeWindow_obj::setMaximized(bool value){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_331_setMaximized)
HXLINE( 333)		if (hx::IsNotNull( this->handle )) {
HXLINE( 336)			return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_maximized(hx::DynamicPtr(this->handle),value);
            		}
...
bool NativeWindow_obj::setMinimized(bool value){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_346_setMinimized)
HXLINE( 348)		if (hx::IsNotNull( this->handle )) {
HXLINE( 351)			return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_minimized(hx::DynamicPtr(this->handle),value);
            		}
...
bool NativeWindow_obj::setResizable(bool value){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_361_setResizable)
HXLINE( 363)		if (hx::IsNotNull( this->handle )) {
HXLINE( 366)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_resizable(hx::DynamicPtr(this->handle),value);
HXLINE( 370)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_borderless(hx::DynamicPtr(this->handle),!(this->parent->_hx___borderless));
...
::String NativeWindow_obj::setTitle(::String value){
            	HX_STACKFRAME(&_hx_pos_fe3f835f12a28e22_380_setTitle)
HXLINE( 382)		if (hx::IsNotNull( this->handle )) {
HXLINE( 385)			return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_window_set_title(hx::DynamicPtr(this->handle),value)) );
            		}
HXLINE( 390)		return value;
            	}
