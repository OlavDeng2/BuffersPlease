...
HX_DEFINE_STACK_FRAME(_hx_pos_3b7a66bddb205621_786_new,"lime._backend.native._NativeApplication.GamepadEventInfo","new",0xafb72336,"lime._backend.native._NativeApplication.GamepadEventInfo.new","lime/_backend/native/NativeApplication.hx",786,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_3b7a66bddb205621_799_clone,"lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",799,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float value = __o_value.Default(0);
            	HX_STACKFRAME(&_hx_pos_3b7a66bddb205621_786_new)
HXLINE( 788)		this->type = type;
HXLINE( 789)		this->id = id;
HXLINE( 790)		this->button = button;
HXLINE( 791)		this->axis = axis;
HXLINE( 792)		this->value = value;
            	}
...
bool GamepadEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3b7a66bddb205621_799_clone)
HXDLIN( 799)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->button,this->axis,this->value);
            	}
