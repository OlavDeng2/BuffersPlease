...
HX_LOCAL_STACK_FRAME(_hx_pos_b3b993f62d801895_224___init__,"::ApplicationMain_obj","__init__",0x253d991d,"::ApplicationMain_obj.__init__","ApplicationMain.hx",224,0x0780ded5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6fcf922b66429816_94_create,"ApplicationMain","create",0x2f7db141,"ApplicationMain.create","ApplicationMain.hx",94,0x0780ded5)
HX_LOCAL_STACK_FRAME(_hx_pos_6fcf922b66429816_84_create,"ApplicationMain","create",0x2f7db141,"ApplicationMain.create","ApplicationMain.hx",84,0x0780ded5)
HX_LOCAL_STACK_FRAME(_hx_pos_6fcf922b66429816_127_start,"ApplicationMain","start",0x45b5d9bd,"ApplicationMain.start","ApplicationMain.hx",127,0x0780ded5)
...
void ApplicationMain_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_b3b993f62d801895_224___init__)
HXDLIN( 224)		 ::Dynamic init = hx::ClassOf< ::lime::app::Application >();
            	}


void ApplicationMain_obj::main(){
            	HX_STACKFRAME(&_hx_pos_6fcf922b66429816_21_main)
HXLINE(  23)		::String projectName = HX_("BuffersPlease",9d,9b,21,cd);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("Andrey NekoBear Studios",5d,e2,4f,43))
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("589",76,68,28,00))
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(20)
            				...
            				->setFixed(9,HX_("title",98,15,3b,10),HX_("BuffersPlease",9d,9b,21,cd))
            				->setFixed(10,HX_("borderless",45,46,71,17),false)
            				->setFixed(11,HX_("background",ee,93,1d,26),(int)0)
            				...
            				->setFixed(17,HX_("parameters",aa,be,7e,51), ::Dynamic(hx::Anon_obj::Create(0)))
            				->setFixed(18,HX_("depthBuffer",63,46,9e,52),false)
            				->setFixed(19,HX_("hardware",a8,e2,d3,75),true))))
            			->setFixed(3,HX_("orientation",d0,ee,fe,fd),HX_("portrait",5b,21,af,b8))
            			->setFixed(4,HX_("fps",e9,c7,4d,00),(int)60)
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("com.Olav.Buffers",a4,6a,75,92))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("BuffersPlease",9d,9b,21,cd))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("BuffersPlease",9d,9b,21,cd))
            			->setFixed(8,HX_("version",18,e7,f1,7c),HX_("1.0.0",b5,d1,2e,55)));
HXLINE(  63)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(projectName,::ApplicationMain_obj::create_dyn(),config);
HXLINE(  78)		::ApplicationMain_obj::create(config);
            	}
...
void ApplicationMain_obj::create( ::Dynamic config){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_6fcf922b66429816_94_create)
HXLINE(  94)			::ApplicationMain_obj::start(a1);
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_6fcf922b66429816_84_create)
HXLINE(  86)		 ::openfl::display::Application app =  ::openfl::display::Application_obj::__alloc( HX_CTX );
HXLINE(  87)		app->create(config);
HXLINE(  89)		::ManifestResources_obj::init(config);
HXLINE(  91)		 ::openfl::display::Preloader preloader =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::openfl::display::DefaultPreloader_obj::__alloc( HX_CTX ));
HXLINE(  92)		app->setPreloader(preloader);
HXLINE(  93)		preloader->create(config);
HXLINE(  94)		 ::openfl::display::Stage a1 = app->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >()->stage;
HXDLIN(  94)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(a1));
HXDLIN(  94)		preloader->onComplete->add(_hx_tmp,null(),null());
HXLINE(  96)		{
HXLINE(  96)			int _g = (int)0;
HXDLIN(  96)			::Array< ::Dynamic> _g1 = ::ManifestResources_obj::preloadLibraries;
HXDLIN(  96)			while((_g < _g1->length)){
HXLINE(  96)				 ::lime::utils::AssetLibrary library = _g1->__get(_g).StaticCast<  ::lime::utils::AssetLibrary >();
HXDLIN(  96)				_g = (_g + (int)1);
HXLINE(  98)				preloader->addLibrary(library);
            			}
            		}
HXLINE( 102)		{
HXLINE( 102)			int _g2 = (int)0;
HXDLIN( 102)			::Array< ::String > _g11 = ::ManifestResources_obj::preloadLibraryNames;
HXDLIN( 102)			while((_g2 < _g11->length)){
HXLINE( 102)				::String name = _g11->__get(_g2);
HXDLIN( 102)				_g2 = (_g2 + (int)1);
HXLINE( 104)				preloader->addLibraryName(name);
            			}
            		}
HXLINE( 108)		preloader->load();
HXLINE( 110)		int result = app->exec();
HXLINE( 113)		::lime::_hx_system::System_obj::exit(result);
            	}
...
void ApplicationMain_obj::start( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_6fcf922b66429816_127_start)
HXDLIN( 127)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 180)			{
HXLINE( 182)				 ::openfl::display::DisplayObject current = stage->getChildAt((int)0);
HXLINE( 184)				bool _hx_tmp;
HXDLIN( 184)				if (hx::IsNotNull( current )) {
HXLINE( 184)					_hx_tmp = !(::Std_obj::is(current,hx::ClassOf< ::openfl::display::DisplayObjectContainer >()));
            				}
            				else {
HXLINE( 184)					_hx_tmp = true;
            				}
HXDLIN( 184)				if (_hx_tmp) {
HXLINE( 186)					current =  ::openfl::display::MovieClip_obj::__alloc( HX_CTX );
HXLINE( 187)					stage->addChild(current);
            				}
HXLINE( 191)				 ::DocumentClass_obj::__alloc( HX_CTX ,( ( ::openfl::display::DisplayObjectContainer)(current) ));
            			}
HXLINE( 131)			stage->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("resize",f4,59,7b,08),false,false));
HXLINE( 133)			if (stage->window->_hx___fullscreen) {
HXLINE( 135)				stage->dispatchEvent( ::openfl::events::FullScreenEvent_obj::__alloc( HX_CTX ,HX_("fullScreen",5b,ae,48,2e),false,false,true,true));
            			}
            		}
            		catch( ::Dynamic _hx_e){
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE( 141)				stage->_hx___handleError(e);
            			}
            			else {
