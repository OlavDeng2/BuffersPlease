...
HXLINE( 286)		current->addChild(hx::ObjectPtr<OBJ_>(this));
HXLINE( 287)		super::__construct();
HXLINE( 288)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("addedToStage",63,22,55,0c),false,false));
            	}
