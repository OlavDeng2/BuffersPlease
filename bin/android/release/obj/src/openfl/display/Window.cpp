...
HXLINE(  38)			this->stage->get_loaderInfo()->parameters =  ::Dynamic(this->config->__Field(HX_("parameters",aa,be,7e,51),hx::paccDynamic));
            		}
HXLINE(  42)		bool _hx_tmp1;
HXDLIN(  42)		if (::Reflect_obj::hasField(this->config,HX_("resizable",6b,37,50,a9))) {
HXLINE(  42)			_hx_tmp1 = !(( (bool)(this->config->__Field(HX_("resizable",6b,37,50,a9),hx::paccDynamic)) ));
            		}
            		else {
HXLINE(  42)			_hx_tmp1 = false;
            		}
HXDLIN(  42)		if (_hx_tmp1) {
HXLINE(  44)			this->stage->_hx___setLogicalSize(( (int)(this->config->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) ),( (int)(this->config->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) ));
            		}
HXLINE(  48)		application->addModule(this->stage);
            	}
