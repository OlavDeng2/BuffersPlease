...
HXDLIN( 128)			_hx_tmp = (this->_hx___worldAlpha <= (int)0);
            		}
            		else {
HXDLIN( 128)			_hx_tmp = true;
            		}
HXDLIN( 128)		if (!(_hx_tmp)) {
HXDLIN( 128)			 ::lime::graphics::cairo::Cairo cairo = renderSession->cairo;
HXDLIN( 128)			bool _hx_tmp1;
HXDLIN( 128)			if (hx::IsNotNull( this->bitmapData )) {
HXDLIN( 128)				_hx_tmp1 = this->bitmapData->_hx___isValid;
            			}
            			else {
HXDLIN( 128)				_hx_tmp1 = false;
            			}
HXDLIN( 128)			if (_hx_tmp1) {
HXDLIN( 128)				renderSession->maskManager->pushObject(hx::ObjectPtr<OBJ_>(this),null());
HXDLIN( 128)				 ::openfl::geom::Matrix transform = this->_hx___renderTransform;
HXDLIN( 128)				if (renderSession->roundPixels) {
HXDLIN( 128)					 ::lime::math::Matrix3 matrix = transform->_hx___toMatrix3();
...
HXDLIN( 128)					cairo->set_matrix(transform->_hx___toMatrix3());
            				}
HXDLIN( 128)				 ::Dynamic surface = this->bitmapData->getSurface();
HXDLIN( 128)				if (hx::IsNotNull( surface )) {
HXDLIN( 128)					 ::Dynamic pattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
HXDLIN( 128)					int _hx_tmp2;
HXDLIN( 128)					bool _hx_tmp3;
HXDLIN( 128)					if (renderSession->allowSmoothing) {
HXDLIN( 128)						_hx_tmp3 = this->smoothing;
            					}
            					else {
HXDLIN( 128)						_hx_tmp3 = false;
            					}
HXDLIN( 128)					if (_hx_tmp3) {
HXDLIN( 128)						_hx_tmp2 = (int)1;
            					}
            					else {
HXDLIN( 128)						_hx_tmp2 = (int)3;
            					}
...
HXDLIN( 128)						cairo->paint();
            					}
            					else {
HXDLIN( 128)						cairo->paintWithAlpha(this->_hx___worldAlpha);
            					}
            				}
...
HXDLIN( 136)		 ::lime::graphics::cairo::Cairo renderSession1 = renderSession->cairo;
...
HXDLIN( 150)		 ::lime::graphics::CanvasRenderContext renderSession1 = renderSession->context;
...
HXDLIN( 166)			_hx_tmp = (this->_hx___worldAlpha <= (int)0);
            		}
            		else {
HXDLIN( 166)			_hx_tmp = true;
            		}
HXDLIN( 166)		if (!(_hx_tmp)) {
HXDLIN( 166)			bool _hx_tmp1;
HXDLIN( 166)			if (hx::IsNotNull( this->bitmapData )) {
HXDLIN( 166)				_hx_tmp1 = this->bitmapData->_hx___isValid;
            			}
            			else {
HXDLIN( 166)				_hx_tmp1 = false;
            			}
HXDLIN( 166)			if (_hx_tmp1) {
HXDLIN( 166)				 ::openfl::_internal::renderer::opengl::GLRenderer renderer = ( ( ::openfl::_internal::renderer::opengl::GLRenderer)(renderSession->renderer) );
HXDLIN( 166)				 ::lime::_backend::native::NativeGLRenderContext gl = renderSession->gl;
HXDLIN( 166)				renderSession->blendModeManager->setBlendMode(this->_hx___worldBlendMode);
...
HXDLIN( 166)					if (!(this->smoothing)) {
HXDLIN( 166)						_hx_tmp2 = renderSession->upscaled;
            					}
            					else {
HXDLIN( 166)						_hx_tmp2 = true;
            					}
            				}
            				else {
HXDLIN( 166)					_hx_tmp2 = false;
            				}
...
HXDLIN( 166)				int _hx_tmp3 = shader->get_data()->aPosition->index;
HXDLIN( 166)				int gl2 = gl->FLOAT;
HXDLIN( 166)				gl->vertexAttribPointer(_hx_tmp3,(int)3,gl2,false,(int)24,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt((int)0));
HXDLIN( 166)				int _hx_tmp4 = shader->get_data()->aTexCoord->index;
HXDLIN( 166)				int gl3 = gl->FLOAT;
HXDLIN( 166)				gl->vertexAttribPointer(_hx_tmp4,(int)2,gl3,false,(int)24,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt((int)12));
HXDLIN( 166)				int _hx_tmp5 = shader->get_data()->aAlpha->index;
HXDLIN( 166)				int gl4 = gl->FLOAT;
HXDLIN( 166)				gl->vertexAttribPointer(_hx_tmp5,(int)1,gl4,false,(int)24,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt((int)20));
