...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_52_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",52,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_64_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",64,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_79_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",79,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_84___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",84,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_152___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",152,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_162___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",162,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_172___renderCairo,"openfl.display.Stage3D","__renderCairo",0x4faad7c9,"openfl.display.Stage3D.__renderCairo","openfl/display/Stage3D.hx",172,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_186___renderCanvas,"openfl.display.Stage3D","__renderCanvas",0x69230677,"openfl.display.Stage3D.__renderCanvas","openfl/display/Stage3D.hx",186,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_200___renderDOM,"openfl.display.Stage3D","__renderDOM",0x9069cb83,"openfl.display.Stage3D.__renderDOM","openfl/display/Stage3D.hx",200,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_224___renderGL,"openfl.display.Stage3D","__renderGL",0x25621024,"openfl.display.Stage3D.__renderGL","openfl/display/Stage3D.hx",224,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_244___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",244,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_258___resetContext3DStates,"openfl.display.Stage3D","__resetContext3DStates",0x6c934f5c,"openfl.display.Stage3D.__resetContext3DStates","openfl/display/Stage3D.hx",258,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_268_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",268,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_285_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",285,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_52_new)
HXLINE(  54)		super::__construct(null());
HXLINE(  56)		this->set_x((int)0);
HXLINE(  57)		this->set_y((int)0);
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
 ...
 ::Dynamic profile = __o_profile.Default(0);
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_64_requestContext3D)
HXLINE(  66)		this->_hx___contextRequested = true;
HXLINE(  68)		if (hx::IsNotNull( this->context3D )) {
HXLINE(  70)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),(int)1);
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_79_requestContext3DMatchingProfiles)
HXDLIN(  79)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_84___createContext)
HXLINE(  86)		this->_hx___stage = stage;
HXLINE(  88)		if (hx::IsNotNull( renderSession->gl )) {
HXLINE(  90)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),renderSession);
HXLINE(  91)			this->_hx___dispatchCreate();
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_152___dispatchError)
HXLINE( 154)		this->_hx___contextRequested = false;
HXLINE( 155)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_162___dispatchCreate)
HXDLIN( 162)		if (this->_hx___contextRequested) {
HXLINE( 164)			this->_hx___contextRequested = false;
HXLINE( 165)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___renderCairo( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_172___renderCairo)
HXLINE( 174)		if (!(this->visible)) {
HXLINE( 174)			return;
            		}
HXLINE( 176)		if (this->_hx___contextRequested) {
HXLINE( 178)			this->_hx___dispatchError();
HXLINE( 179)			this->_hx___contextRequested = false;
            		}
            	}
...
void Stage3D_obj::_hx___renderCanvas( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_186___renderCanvas)
HXLINE( 188)		if (!(this->visible)) {
HXLINE( 188)			return;
            		}
HXLINE( 190)		if (this->_hx___contextRequested) {
HXLINE( 192)			this->_hx___dispatchError();
HXLINE( 193)			this->_hx___contextRequested = false;
            		}
            	}
...
void Stage3D_obj::_hx___renderDOM( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_200___renderDOM)
HXLINE( 202)		if (!(this->visible)) {
HXLINE( 202)			return;
            		}
HXLINE( 204)		bool _hx_tmp;
HXDLIN( 204)		if (this->_hx___contextRequested) {
HXLINE( 204)			_hx_tmp = hx::IsNull( this->context3D );
            		}
            		else {
HXLINE( 204)			_hx_tmp = false;
            		}
HXDLIN( 204)		if (_hx_tmp) {
HXLINE( 206)			this->_hx___createContext(stage,renderSession);
            		}
HXLINE( 210)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 216)			this->_hx___resetContext3DStates();
            		}
            	}
...
void Stage3D_obj::_hx___renderGL( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_224___renderGL)
HXLINE( 226)		if (!(this->visible)) {
HXLINE( 226)			return;
            		}
HXLINE( 228)		bool _hx_tmp;
HXDLIN( 228)		if (this->_hx___contextRequested) {
HXLINE( 228)			_hx_tmp = hx::IsNull( this->context3D );
            		}
            		else {
HXLINE( 228)			_hx_tmp = false;
            		}
HXDLIN( 228)		if (_hx_tmp) {
HXLINE( 230)			this->_hx___createContext(stage,renderSession);
            		}
HXLINE( 234)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 236)			this->_hx___resetContext3DStates();
HXLINE( 237)			{
HXLINE( 237)				if (hx::IsNotNull( this->context3D )) {
HXLINE( 237)					renderSession->blendModeManager->setBlendMode(null());
HXDLIN( 237)					if (hx::IsNotNull( renderSession->shaderManager->currentShader )) {
HXLINE( 237)						renderSession->shaderManager->setShader(null());
HXDLIN( 237)						if (hx::IsNotNull( this->context3D->_hx___program )) {
HXLINE( 237)							this->context3D->_hx___program->_hx___use();
            						}
            					}
            				}
HXDLIN( 237)				if (::openfl::_internal::stage3D::GLUtils_obj::debug) {
HXLINE( 237)					renderSession->gl->getError();
            				}
            			}
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_244___resize)
            	}
...
void Stage3D_obj::_hx___resetContext3DStates(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_258___resetContext3DStates)
HXLINE( 261)		this->context3D->_hx___updateBlendFactors();
HXLINE( 263)		this->context3D->_hx___updateBackbufferViewport();
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_268_set_x)
HXLINE( 270)		if ((this->x == value)) {
HXLINE( 270)			return value;
            		}
HXLINE( 272)		this->x = value;
HXLINE( 274)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 276)			this->context3D->_hx___updateBackbufferViewport();
            		}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_285_set_y)
HXLINE( 287)		if ((this->y == value)) {
HXLINE( 287)			return value;
            		}
HXLINE( 289)		this->y = value;
HXLINE( 291)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 293)			this->context3D->_hx___updateBackbufferViewport();
            		}
