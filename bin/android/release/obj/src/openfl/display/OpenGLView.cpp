...
HX_DEFINE_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_40_new,"openfl.display.OpenGLView","new",0xbc210f50,"openfl.display.OpenGLView.new","openfl/display/OpenGLView.hx",40,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_89___renderCanvas,"openfl.display.OpenGLView","__renderCanvas",0x35af22fe,"openfl.display.OpenGLView.__renderCanvas","openfl/display/OpenGLView.hx",89,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_105___renderDOM,"openfl.display.OpenGLView","__renderDOM",0x0611a49c,"openfl.display.OpenGLView.__renderDOM","openfl/display/OpenGLView.hx",105,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_183___renderGL,"openfl.display.OpenGLView","__renderGL",0x34d59d2b,"openfl.display.OpenGLView.__renderGL","openfl/display/OpenGLView.hx",183,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_254_get_isSupported,"openfl.display.OpenGLView","get_isSupported",0x72941b6b,"openfl.display.OpenGLView.get_isSupported","openfl/display/OpenGLView.hx",254,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_29_boot,"openfl.display.OpenGLView","boot",0xd8e55742,"openfl.display.OpenGLView.boot","openfl/display/OpenGLView.hx",29,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_30_boot,"openfl.display.OpenGLView","boot",0xd8e55742,"openfl.display.OpenGLView.boot","openfl/display/OpenGLView.hx",30,0x7a9fe7de)
namespace openfl{
namespace display{

void OpenGLView_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_ea3b26280d7ee2f2_40_new)
HXDLIN(  40)		super::__construct(HX_("OpenGLView",94,0e,ac,6e));
            	}
...
void OpenGLView_obj::_hx___renderCanvas( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_ea3b26280d7ee2f2_89___renderCanvas)
            	}


void OpenGLView_obj::_hx___renderDOM( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_ea3b26280d7ee2f2_105___renderDOM)
            	}


void OpenGLView_obj::_hx___renderGL( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_GC_STACKFRAME(&_hx_pos_ea3b26280d7ee2f2_183___renderGL)
HXDLIN( 183)		bool _hx_tmp;
HXDLIN( 183)		if (hx::IsNotNull( this->stage )) {
HXDLIN( 183)			_hx_tmp = this->_hx___renderable;
            		}
            		else {
HXDLIN( 183)			_hx_tmp = false;
            		}
HXDLIN( 183)		if (_hx_tmp) {
HXLINE( 185)			 ::openfl::geom::Rectangle rect = null();
HXLINE( 187)			if (hx::IsNull( this->_hx___scrollRect )) {
HXLINE( 189)				rect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,this->stage->stageWidth,this->stage->stageHeight);
            			}
            			else {
HXLINE( 193)				Float rect1 = this->get_x();
HXDLIN( 193)				Float rect2 = (rect1 + this->_hx___scrollRect->x);
HXDLIN( 193)				Float rect3 = this->get_y();
HXDLIN( 193)				rect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,rect2,(rect3 + this->_hx___scrollRect->y),this->_hx___scrollRect->width,this->_hx___scrollRect->height);
            			}
HXLINE( 197)			renderSession->shaderManager->setShader(null());
HXLINE( 198)			renderSession->blendModeManager->setBlendMode(null());
HXLINE( 200)			if (hx::IsNotNull( this->_hx___render )) {
HXLINE( 200)				this->_hx___render(rect);
            			}
            		}
            	}
...
bool OpenGLView_obj::get_isSupported(){
            	HX_STACKFRAME(&_hx_pos_ea3b26280d7ee2f2_254_get_isSupported)
...
{
{
            	HX_STACKFRAME(&_hx_pos_ea3b26280d7ee2f2_29_boot)
HXDLIN(  29)		CONTEXT_LOST = HX_("glcontextlost",4e,21,17,07);
            	}
{
            	HX_STACKFRAME(&_hx_pos_ea3b26280d7ee2f2_30_boot)
HXDLIN(  30)		CONTEXT_RESTORED = HX_("glcontextrestored",c0,71,0a,02);
            	}
}
