...
HXDLIN(  32)		return this->_hx___render;
            	}
...
HXDLIN(  39)		return (this->_hx___render = value);
            	}
...
hx::Val DirectRenderer_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"render") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_render(inValue.Cast<  ::Dynamic >()) ); }
		break;
	case 8:
