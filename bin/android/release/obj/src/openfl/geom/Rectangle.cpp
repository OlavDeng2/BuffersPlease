...
HXDLIN(  43)		return  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,this->x,this->y,this->width,this->height);
            	}
...
HXDLIN(  50)			_hx_tmp1 = (y >= this->y);
            		}
            		else {
HXDLIN(  50)			_hx_tmp1 = false;
            		}
HXDLIN(  50)		if (_hx_tmp1) {
HXDLIN(  50)			_hx_tmp = (x < this->get_right());
            		}
            		else {
HXDLIN(  50)			_hx_tmp = false;
            		}
HXDLIN(  50)		if (_hx_tmp) {
HXDLIN(  50)			return (y < this->get_bottom());
            		}
            		else {
...
HXDLIN(  57)		return this->contains(point->x,point->y);
            	}
...
HXDLIN(  64)			_hx_tmp = (rect->height <= (int)0);
            		}
            		else {
...
HXDLIN(  89)		if (hx::IsEq( toCompare,hx::ObjectPtr<OBJ_>(this) )) {
...
HXDLIN( 105)		this->inflate(point->x,point->y);
            	}
...
HXDLIN( 156)		if (!((this->width <= (int)0))) {
HXDLIN( 156)			return (this->height <= (int)0);
            		}
            		else {
...
HXDLIN( 179)		this->x = (this->y = (this->width = (this->height = (int)0)));
            	}
...
HXDLIN( 196)		return ((((((((HX_("(x=",ed,c2,1e,00) + this->x) + HX_(", y=",18,15,2e,1d)) + this->y) + HX_(", width=",eb,04,57,53)) + this->width) + HX_(", height=",82,32,07,68)) + this->height) + HX_(")",29,00,00,00));
            	}
...
HXDLIN( 337)		return (this->y + this->height);
            	}
...
HXDLIN( 338)		this->height = (b - this->y);
HXDLIN( 338)		return b;
            	}
...
HXDLIN( 339)		Float _hx_tmp = (this->x + this->width);
...
HXDLIN( 340)		this->width = (p->x - this->x);
...
HXDLIN( 342)		 ::openfl::geom::Rectangle _hx_tmp = hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 343)		return (this->x + this->width);
            	}
...
HXDLIN( 344)		this->width = (r - this->x);
HXDLIN( 344)		return r;
            	}
...
HXDLIN( 345)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,this->width,this->height);
            	}
...
HXDLIN( 348)		 ::openfl::geom::Rectangle _hx_tmp = hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 349)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,this->x,this->y);
            	}
...
HXDLIN(  16)		_hx___temp =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            	}
}
