...
HX_DEFINE_STACK_FRAME(_hx_pos_9cb7cf8686767cce_24_new,"openfl._internal.symbols.StaticTextSymbol","new",0x75321c28,"openfl._internal.symbols.StaticTextSymbol.new","openfl/_internal/symbols/StaticTextSymbol.hx",24,0x451958e5)
HX_LOCAL_STACK_FRAME(_hx_pos_9cb7cf8686767cce_29___createObject,"openfl._internal.symbols.StaticTextSymbol","__createObject",0xe6e27b33,"openfl._internal.symbols.StaticTextSymbol.__createObject","openfl/_internal/symbols/StaticTextSymbol.hx",29,0x451958e5)
namespace openfl{
namespace _internal{
namespace symbols{

void StaticTextSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_9cb7cf8686767cce_24_new)
...
bool StaticTextSymbol_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::DisplayObject StaticTextSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_GC_STACKFRAME(&_hx_pos_9cb7cf8686767cce_29___createObject)
HXLINE(  31)		 ::openfl::display::Shape shape =  ::openfl::display::Shape_obj::__alloc( HX_CTX );
HXLINE(  32)		 ::openfl::display::Graphics graphics = shape->get_graphics();
HXLINE(  34)		if (hx::IsNotNull( this->rendered )) {
HXLINE(  36)			graphics->copyFrom(this->rendered->get_graphics());
HXLINE(  37)			return shape;
            		}
HXLINE(  41)		if (hx::IsNotNull( this->records )) {
HXLINE(  43)			 ::openfl::_internal::symbols::FontSymbol font = null();
HXLINE(  44)			int color = (int)16777215;
HXLINE(  45)			Float offsetX = this->matrix->tx;
HXLINE(  46)			Float offsetY = this->matrix->ty;
HXLINE(  48)			{
HXLINE(  48)				int _g = (int)0;
HXDLIN(  48)				::Array< ::Dynamic> _g1 = this->records;
HXDLIN(  48)				while((_g < _g1->length)){
HXLINE(  48)					 ::openfl::_internal::symbols::StaticTextRecord record = _g1->__get(_g).StaticCast<  ::openfl::_internal::symbols::StaticTextRecord >();
HXDLIN(  48)					_g = (_g + (int)1);
HXLINE(  50)					if (hx::IsNotNull( record->fontID )) {
HXLINE(  50)						font = ( ( ::openfl::_internal::symbols::FontSymbol)(swf->symbols->get(record->fontID).StaticCast<  ::openfl::_internal::symbols::SWFSymbol >()) );
            					}
HXLINE(  51)					if (hx::IsNotNull( record->offsetX )) {
HXLINE(  51)						Float offsetX1 = this->matrix->tx;
HXDLIN(  51)						offsetX = (offsetX1 + (record->offsetX * ((Float)0.05)));
            					}
HXLINE(  52)					if (hx::IsNotNull( record->offsetY )) {
HXLINE(  52)						Float offsetY1 = this->matrix->ty;
HXDLIN(  52)						offsetY = (offsetY1 + (record->offsetY * ((Float)0.05)));
            					}
HXLINE(  53)					if (hx::IsNotNull( record->color )) {
HXLINE(  53)						color = record->color;
            					}
HXLINE(  55)					if (hx::IsNotNull( font )) {
HXLINE(  57)						Float scale = (((Float)record->fontHeight / (Float)(int)1024) * ((Float)0.05));
HXLINE(  59)						int index;
HXLINE(  60)						 ::Dynamic code;
HXLINE(  62)						{
HXLINE(  62)							int _g3 = (int)0;
HXDLIN(  62)							int _g2 = record->glyphs->length;
HXDLIN(  62)							while((_g3 < _g2)){
HXLINE(  62)								_g3 = (_g3 + (int)1);
HXDLIN(  62)								int i = (_g3 - (int)1);
HXLINE(  64)								index = record->glyphs->__get(i);
HXLINE(  66)								{
HXLINE(  66)									int _g4 = (int)0;
HXDLIN(  66)									::Array< ::Dynamic> _g5 = font->glyphs->__get(index).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(  66)									while((_g4 < _g5->length)){
HXLINE(  66)										 ::openfl::_internal::swf::ShapeCommand command = _g5->__get(_g4).StaticCast<  ::openfl::_internal::swf::ShapeCommand >();
HXDLIN(  66)										_g4 = (_g4 + (int)1);
HXLINE(  68)										switch((int)(_hx_getEnumValueIndex(command))){
            											case (int)1: {
HXLINE(  70)												Float alpha = command->_hx_getFloat(1);
HXLINE(  72)												graphics->beginFill(((int)color & (int)(int)16777215),((Float)((int)((int)color >> (int)(int)24) & (int)(int)255) / (Float)(int)255));
            											}
            											break;
            											case (int)3: {
HXLINE(  74)												Float anchorY = command->_hx_getFloat(3);
HXDLIN(  74)												Float anchorX = command->_hx_getFloat(2);
HXDLIN(  74)												Float controlY = command->_hx_getFloat(1);
HXDLIN(  74)												Float controlX = command->_hx_getFloat(0);
...
HXLINE(  96)												graphics->lineTo(((x * scale) + offsetX),((y * scale) + offsetY));
            											}
            											break;
            											case (int)7: {
HXLINE(  98)												Float y1 = command->_hx_getFloat(1);
HXDLIN(  98)												Float x1 = command->_hx_getFloat(0);
HXLINE( 100)												graphics->moveTo(((x1 * scale) + offsetX),((y1 * scale) + offsetY));
            											}
            											break;
            											default:{
            											}
...
HXLINE( 108)								offsetX = (offsetX + (record->advances->__get(i) * ((Float)0.05)));
            							}
            						}
            					}
            				}
...
HXLINE( 118)		this->records = null();
HXLINE( 119)		this->rendered =  ::openfl::display::Shape_obj::__alloc( HX_CTX );
HXLINE( 120)		 ::openfl::display::Graphics _hx_tmp = this->rendered->get_graphics();
HXDLIN( 120)		_hx_tmp->copyFrom(shape->get_graphics());
HXLINE( 122)		return shape;
            	}
