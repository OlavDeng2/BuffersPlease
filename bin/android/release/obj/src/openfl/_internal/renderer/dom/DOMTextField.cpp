...
HXDLIN( 356)		if (hx::IsNotNull( regex->matched((int)2) )) {
HXDLIN( 356)			return regex->matched((int)2);
            		}
            		else {
HXDLIN( 356)			return regex->matched((int)3);
            		}
...
HXDLIN(  26)		_hx___regexSize =  ::EReg_obj::__alloc( HX_CTX ,HX_("size=(\"([^\"]+)\"|'([^']+)')>",bc,32,a4,3e),HX_("i",69,00,00,00));
            	}
}
