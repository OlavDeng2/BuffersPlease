...
HX_LOCAL_STACK_FRAME(_hx_pos_c141c49e61a6a76a_56_render,"openfl._internal.renderer.cairo.CairoRenderer","render",0xe2c1945a,"openfl._internal.renderer.cairo.CairoRenderer.render","openfl/_internal/renderer/cairo/CairoRenderer.hx",56,0x849037d4)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
HXLINE(  35)		this->renderSession->cairo = cairo;
HXLINE(  37)		this->renderSession->renderer = hx::ObjectPtr<OBJ_>(this);
HXLINE(  38)		this->renderSession->maskManager =  ::openfl::_internal::renderer::cairo::CairoMaskManager_obj::__alloc( HX_CTX ,this->renderSession);
HXLINE(  39)		this->renderSession->blendModeManager =  ::openfl::_internal::renderer::cairo::CairoBlendModeManager_obj::__alloc( HX_CTX ,this->renderSession);
            	}
...
HXDLIN(  47)		int _g = (int)0;
HXDLIN(  47)		 ::openfl::_Vector::ObjectVector _g1 = this->stage->stage3Ds;
HXDLIN(  47)		while((_g < _g1->get_length())){
HXDLIN(  47)			 ::openfl::display::Stage3D stage3D = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN(  47)			_g = (_g + (int)1);
HXLINE(  49)			stage3D->_hx___renderCairo(this->stage,this->renderSession);
            		}
            	}


void CairoRenderer_obj::render(){
            	HX_STACKFRAME(&_hx_pos_c141c49e61a6a76a_56_render)
HXLINE(  58)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE(  60)		this->cairo->identityMatrix();
HXLINE(  62)		if (this->stage->_hx___clearBeforeRender) {
HXLINE(  64)			 ::lime::graphics::cairo::Cairo _hx_tmp = this->cairo;
HXDLIN(  64)			Float _hx_tmp1 = this->stage->_hx___colorSplit->__get((int)0);
HXDLIN(  64)			Float _hx_tmp2 = this->stage->_hx___colorSplit->__get((int)1);
HXDLIN(  64)			_hx_tmp->setSourceRGB(_hx_tmp1,_hx_tmp2,this->stage->_hx___colorSplit->__get((int)2));
HXLINE(  65)			this->cairo->paint();
            		}
