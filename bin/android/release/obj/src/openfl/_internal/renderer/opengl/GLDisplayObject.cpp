...
HXDLIN(  48)						renderSession->blendModeManager->setBlendMode(displayObject->_hx___worldBlendMode);
...
HXDLIN(  48)						int _hx_tmp7 = shader->get_data()->aPosition->index;
HXDLIN(  48)						int gl3 = gl1->FLOAT;
HXDLIN(  48)						gl1->vertexAttribPointer(_hx_tmp7,(int)3,gl3,false,(int)24,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt((int)0));
HXDLIN(  48)						int _hx_tmp8 = shader->get_data()->aTexCoord->index;
HXDLIN(  48)						int gl4 = gl1->FLOAT;
HXDLIN(  48)						gl1->vertexAttribPointer(_hx_tmp8,(int)2,gl4,false,(int)24,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt((int)12));
HXDLIN(  48)						int _hx_tmp9 = shader->get_data()->aAlpha->index;
HXDLIN(  48)						int gl5 = gl1->FLOAT;
HXDLIN(  48)						gl1->vertexAttribPointer(_hx_tmp9,(int)1,gl5,false,(int)24,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt((int)20));
