...
HXDLIN( 255)		if ((width > (int)0)) {
HXLINE( 255)			_hx_tmp = (height > (int)0);
            		}
            		else {
...
HXDLIN( 257)			if (hx::IsNotNull( this->renderTargetA )) {
HXLINE( 257)				if ((this->renderTargetA->width == width)) {
HXLINE( 257)					_hx_tmp1 = (this->renderTargetA->height != height);
            				}
            				else {
...
HXLINE( 259)				this->renderTargetA = ::openfl::display::BitmapData_obj::fromTexture(this->stage->stage3Ds->get((int)0).StaticCast<  ::openfl::display::Stage3D >()->context3D->createRectangleTexture(width,height,(int)1,true));
HXLINE( 261)				 ::lime::_backend::native::NativeGLRenderContext _hx_tmp2 = this->gl;
HXDLIN( 261)				int _hx_tmp3 = this->gl->TEXTURE_2D;
HXDLIN( 261)				_hx_tmp2->bindTexture(_hx_tmp3,this->renderTargetA->getTexture(this->gl));
HXLINE( 262)				this->gl->texParameteri(this->gl->TEXTURE_2D,this->gl->TEXTURE_WRAP_S,this->gl->CLAMP_TO_EDGE);
HXLINE( 263)				this->gl->texParameteri(this->gl->TEXTURE_2D,this->gl->TEXTURE_WRAP_T,this->gl->CLAMP_TO_EDGE);
            			}
HXLINE( 267)			bool _hx_tmp4;
HXDLIN( 267)			if (hx::IsNotNull( this->renderTargetB )) {
HXLINE( 267)				if ((this->renderTargetB->width == width)) {
HXLINE( 267)					_hx_tmp4 = (this->renderTargetB->height != height);
            				}
            				else {
HXLINE( 267)					_hx_tmp4 = true;
            				}
            			}
            			else {
HXLINE( 267)				_hx_tmp4 = false;
            			}
HXDLIN( 267)			if (_hx_tmp4) {
HXLINE( 269)				this->renderTargetB = ::openfl::display::BitmapData_obj::fromTexture(this->stage->stage3Ds->get((int)0).StaticCast<  ::openfl::display::Stage3D >()->context3D->createRectangleTexture(width,height,(int)1,true));
HXLINE( 271)				 ::lime::_backend::native::NativeGLRenderContext _hx_tmp5 = this->gl;
HXDLIN( 271)				int _hx_tmp6 = this->gl->TEXTURE_2D;
HXDLIN( 271)				_hx_tmp5->bindTexture(_hx_tmp6,this->renderTargetB->getTexture(this->gl));
HXLINE( 272)				this->gl->texParameteri(this->gl->TEXTURE_2D,this->gl->TEXTURE_WRAP_S,this->gl->CLAMP_TO_EDGE);
HXLINE( 273)				this->gl->texParameteri(this->gl->TEXTURE_2D,this->gl->TEXTURE_WRAP_T,this->gl->CLAMP_TO_EDGE);
            			}
            		}
HXLINE( 279)		this->displayMatrix = this->stage->_hx___displayMatrix;
HXLINE( 281)		 ::openfl::geom::Matrix _this = this->displayMatrix;
HXDLIN( 281)		Float _hx_tmp7 = ((int)0 * _this->a);
HXDLIN( 281)		this->offsetX = ::Math_obj::round(((_hx_tmp7 + ((int)0 * _this->c)) + _this->tx));
HXLINE( 282)		 ::openfl::geom::Matrix _this1 = this->displayMatrix;
HXDLIN( 282)		Float _hx_tmp8 = ((int)0 * _this1->b);
HXDLIN( 282)		this->offsetY = ::Math_obj::round(((_hx_tmp8 + ((int)0 * _this1->d)) + _this1->ty));
HXLINE( 283)		 ::openfl::geom::Matrix _this2 = this->displayMatrix;
HXDLIN( 283)		Float _hx_tmp9 = (this->stage->stageWidth * _this2->a);
HXDLIN( 283)		this->displayWidth = ::Math_obj::round((((_hx_tmp9 + ((int)0 * _this2->c)) + _this2->tx) - this->offsetX));
HXLINE( 284)		 ::openfl::geom::Matrix _this3 = this->displayMatrix;
HXDLIN( 284)		Float _hx_tmp10 = ((int)0 * _this3->b);
HXDLIN( 284)		this->displayHeight = ::Math_obj::round((((_hx_tmp10 + (this->stage->stageHeight * _this3->d)) + _this3->ty) - this->offsetY));
HXLINE( 286)		int _hx_tmp11 = this->offsetX;
HXDLIN( 286)		int _hx_tmp12 = (this->displayWidth + this->offsetX);
HXDLIN( 286)		int _hx_tmp13 = this->offsetY;
HXDLIN( 286)		this->projection = ::lime::math::_Matrix4::Matrix4_Impl__obj::createOrtho(_hx_tmp11,_hx_tmp12,_hx_tmp13,(this->displayHeight + this->offsetY),(int)-1000,(int)1000);
HXLINE( 287)		int _hx_tmp14 = this->offsetX;
HXDLIN( 287)		int _hx_tmp15 = (this->displayWidth + this->offsetX);
HXDLIN( 287)		this->projectionFlipped = ::lime::math::_Matrix4::Matrix4_Impl__obj::createOrtho(_hx_tmp14,_hx_tmp15,(this->displayHeight + this->offsetY),this->offsetY,(int)-1000,(int)1000);
            	}
