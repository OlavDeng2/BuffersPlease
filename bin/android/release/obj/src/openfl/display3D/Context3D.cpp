...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_1366___updateBackbufferViewport,"openfl.display3D.Context3D","__updateBackbufferViewport",0x1ffcf0dd,"openfl.display3D.Context3D.__updateBackbufferViewport","openfl/display3D/Context3D.hx",1366,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_1377_set_enableErrorChecking,"openfl.display3D.Context3D","set_enableErrorChecking",0x101dce5b,"openfl.display3D.Context3D.set_enableErrorChecking","openfl/display3D/Context3D.hx",1377,0xc899cbb9)
...
void Context3D_obj::_hx___updateBackbufferViewport(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1366___updateBackbufferViewport)
HXDLIN(1366)		bool _hx_tmp;
HXDLIN(1366)		bool _hx_tmp1;
HXDLIN(1366)		if (hx::IsNull( this->_hx___renderToTexture )) {
HXDLIN(1366)			_hx_tmp1 = (this->backBufferWidth > (int)0);
            		}
            		else {
HXDLIN(1366)			_hx_tmp1 = false;
            		}
HXDLIN(1366)		if (_hx_tmp1) {
HXDLIN(1366)			_hx_tmp = (this->backBufferHeight > (int)0);
            		}
            		else {
HXDLIN(1366)			_hx_tmp = false;
            		}
HXDLIN(1366)		if (_hx_tmp) {
HXLINE(1368)			int _hx_tmp2 = ::Std_obj::_hx_int(this->_hx___stage3D->x);
HXDLIN(1368)			int _hx_tmp3 = ::Std_obj::_hx_int(this->_hx___stage3D->y);
HXDLIN(1368)			this->_hx___setViewport(_hx_tmp2,_hx_tmp3,this->backBufferWidth,this->backBufferHeight);
            		}
            	}
...
bool Context3D_obj::set_enableErrorChecking(bool value){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1377_set_enableErrorChecking)
HXDLIN(1377)		return (this->enableErrorChecking = (::openfl::_internal::stage3D::GLUtils_obj::debug = value));
            	}
