...
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1387_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1387,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1388_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1388,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1389_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1389,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1390_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1390,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1391_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1391,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1392_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1392,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1393_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1393,0xc899cbb9)
...
{
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1387_boot)
HXDLIN(1387)		DRAW_CALLS = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1388_boot)
HXDLIN(1388)		COUNT_INDEX_BUFFER = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1389_boot)
HXDLIN(1389)		COUNT_VERTEX_BUFFER = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1390_boot)
HXDLIN(1390)		COUNT_TEXTURE = (int)3;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1391_boot)
HXDLIN(1391)		COUNT_TEXTURE_COMPRESSED = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1392_boot)
HXDLIN(1392)		COUNT_PROGRAM = (int)5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1393_boot)
HXDLIN(1393)		MEM_INDEX_BUFFER = (int)6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1394_boot)
HXDLIN(1394)		MEM_VERTEX_BUFFER = (int)7;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1395_boot)
HXDLIN(1395)		MEM_TEXTURE = (int)8;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1396_boot)
HXDLIN(1396)		MEM_TEXTURE_COMPRESSED = (int)9;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1397_boot)
HXDLIN(1397)		MEM_PROGRAM = (int)10;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1399_boot)
HXDLIN(1399)		length = (int)11;
            	}
}
