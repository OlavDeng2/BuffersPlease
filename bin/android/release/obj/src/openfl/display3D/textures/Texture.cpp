...
HXDLIN( 178)			if ((state->minFilter != (int)9987)) {
HXLINE( 178)				_hx_tmp1 = (state->minFilter == (int)9984);
            			}
            			else {
...
HXDLIN( 260)			int _g = mipCount;
HXDLIN( 260)			while((_g1 < _g)){
HXLINE( 260)				_g1 = (_g1 + (int)1);
HXDLIN( 260)				int level = (_g1 - (int)1);
HXLINE( 262)				{
HXLINE( 262)					int _g2 = (int)0;
HXDLIN( 262)					while((_g2 < (int)4)){
HXLINE( 262)						_g2 = (_g2 + (int)1);
HXDLIN( 262)						int gpuFormat = (_g2 - (int)1);
HXLINE( 264)						int blockLength;
HXDLIN( 264)						if ((version == (int)0)) {
HXLINE( 264)							blockLength = this->_hx___readUInt24(data);
            						}
            						else {
HXLINE( 264)							blockLength = this->_hx___readUInt32(data);
            						}
HXLINE( 266)						int a = (data->position + blockLength);
HXDLIN( 266)						int b = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(data);
HXDLIN( 266)						bool aNeg = (a < (int)0);
HXDLIN( 266)						bool bNeg = (b < (int)0);
HXDLIN( 266)						bool _hx_tmp2;
HXDLIN( 266)						if ((aNeg != bNeg)) {
HXLINE( 266)							_hx_tmp2 = aNeg;
            						}
            						else {
HXLINE( 266)							_hx_tmp2 = (a > b);
            						}
HXDLIN( 266)						if (_hx_tmp2) {
HXLINE( 268)							HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("Block length exceeds ATF file length",15,23,c0,24)));
            						}
HXLINE( 272)						bool aNeg1 = (blockLength < (int)0);
HXDLIN( 272)						bool bNeg1 = ((int)0 < (int)0);
HXDLIN( 272)						bool _hx_tmp3;
HXDLIN( 272)						if ((aNeg1 != bNeg1)) {
HXLINE( 272)							_hx_tmp3 = aNeg1;
            						}
            						else {
HXLINE( 272)							_hx_tmp3 = (blockLength > (int)0);
            						}
HXDLIN( 272)						if (_hx_tmp3) {
HXLINE( 275)							if ((gpuFormat == (int)0)) {
HXLINE( 279)								 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc(blockLength);
HXLINE( 280)								data->readBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromArrayBuffer(bytes),(int)0,blockLength);
HXLINE( 282)								{
HXLINE( 282)									int target = this->_hx___textureTarget;
HXDLIN( 282)									int internalformat = this->_hx___format;
HXDLIN( 282)									Float data1 = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromArrayBuffer(bytes);
HXDLIN( 282)									 ::lime::_backend::native::NativeGLRenderContext _hx_tmp4 = ::lime::graphics::opengl::GL_obj::context;
HXDLIN( 282)									_hx_tmp4->compressedTexImage2D(target,level,internalformat,((int)width >> (int)level),((int)height >> (int)level),(int)0,blockLength,data1);
            								}
HXLINE( 283)								::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
            							}
            							else {
HXLINE( 289)								data->position = (data->position + blockLength);
            							}
            						}
            					}
            				}
