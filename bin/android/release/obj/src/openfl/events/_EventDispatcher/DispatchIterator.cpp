...
HX_DEFINE_STACK_FRAME(_hx_pos_eed9e911a94343be_267_new,"openfl.events._EventDispatcher.DispatchIterator","new",0x76c2678f,"openfl.events._EventDispatcher.DispatchIterator.new","openfl/events/EventDispatcher.hx",267,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_277_copy,"openfl.events._EventDispatcher.DispatchIterator","copy",0x6c1a6da6,"openfl.events._EventDispatcher.DispatchIterator.copy","openfl/events/EventDispatcher.hx",277,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_289_hasNext,"openfl.events._EventDispatcher.DispatchIterator","hasNext",0xef22001c,"openfl.events._EventDispatcher.DispatchIterator.hasNext","openfl/events/EventDispatcher.hx",289,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_305_next,"openfl.events._EventDispatcher.DispatchIterator","next",0x735836e4,"openfl.events._EventDispatcher.DispatchIterator.next","openfl/events/EventDispatcher.hx",305,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_312_remove,"openfl.events._EventDispatcher.DispatchIterator","remove",0xb5236c75,"openfl.events._EventDispatcher.DispatchIterator.remove","openfl/events/EventDispatcher.hx",312,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_342_reset,"openfl.events._EventDispatcher.DispatchIterator","reset",0xc76e4abe,"openfl.events._EventDispatcher.DispatchIterator.reset","openfl/events/EventDispatcher.hx",342,0xe2270714)
namespace openfl{
namespace events{
namespace _EventDispatcher{

void DispatchIterator_obj::__construct(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_267_new)
HXLINE( 269)		this->list = list;
HXLINE( 270)		this->index = list->length;
            	}
...
void DispatchIterator_obj::copy(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_277_copy)
HXDLIN( 277)		bool _hx_tmp;
HXDLIN( 277)		if ((this->index < this->list->length)) {
HXDLIN( 277)			_hx_tmp = !(this->isCopy);
            		}
            		else {
HXDLIN( 277)			_hx_tmp = false;
            		}
HXDLIN( 277)		if (_hx_tmp) {
HXLINE( 279)			this->list = this->list->copy();
HXLINE( 280)			this->isCopy = true;
            		}
            	}
...
bool DispatchIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_289_hasNext)
HXDLIN( 289)		if ((this->index < this->list->length)) {
HXLINE( 291)			return true;
            		}
            		else {
HXLINE( 295)			this->active = false;
...
HX_DEFINE_DYNAMIC_FUNC0(DispatchIterator_obj,hasNext,return )
 ...
 ::openfl::events::_EventDispatcher::Listener DispatchIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_305_next)
HXDLIN( 305)		::Array< ::Dynamic> _hx_tmp = this->list;
HXDLIN( 305)		return _hx_tmp->__get(this->index++).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
            	}
...
void DispatchIterator_obj::remove( ::openfl::events::_EventDispatcher::Listener listener,int listIndex){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_312_remove)
HXDLIN( 312)		if (this->active) {
HXLINE( 314)			if (!(this->isCopy)) {
HXLINE( 316)				if ((listIndex < this->index)) {
HXLINE( 318)					this->index--;
            				}
            			}
            			else {
HXLINE( 324)				int _g1 = this->index;
HXDLIN( 324)				int _g = this->list->length;
HXDLIN( 324)				while((_g1 < _g)){
HXLINE( 324)					_g1 = (_g1 + (int)1);
HXDLIN( 324)					int i = (_g1 - (int)1);
HXLINE( 326)					if (hx::IsEq( this->list->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >(),listener )) {
HXLINE( 328)						this->list->removeRange(i,(int)1);
...
void DispatchIterator_obj::reset(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_342_reset)
HXLINE( 344)		this->list = list;
HXLINE( 346)		this->active = true;
HXLINE( 347)		this->index = (int)0;
            	}
