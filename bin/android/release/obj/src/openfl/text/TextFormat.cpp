...
HX_DEFINE_STACK_FRAME(_hx_pos_c5f39c48023aa9de_33_new,"openfl.text.TextFormat","new",0xfdb2c999,"openfl.text.TextFormat.new","openfl/text/TextFormat.hx",33,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_52_clone,"openfl.text.TextFormat","clone",0x965d8cd6,"openfl.text.TextFormat.clone","openfl/text/TextFormat.hx",52,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_73___merge,"openfl.text.TextFormat","__merge",0x0ccb8551,"openfl.text.TextFormat.__merge","openfl/text/TextFormat.hx",73,0xd3329397)
namespace openfl{
namespace text{
...
void TextFormat_obj::__construct(::String font, ::Dynamic size, ::Dynamic color, ::Dynamic bold, ::Dynamic italic, ::Dynamic underline,::String url,::String target, ::Dynamic align, ::Dynamic leftMargin, ::Dynamic rightMargin, ::Dynamic indent, ::Dynamic leading){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_33_new)
HXLINE(  35)		this->font = font;
HXLINE(  36)		this->size = size;
HXLINE(  37)		this->color = color;
HXLINE(  38)		this->bold = bold;
HXLINE(  39)		this->italic = italic;
HXLINE(  40)		this->underline = underline;
HXLINE(  41)		this->url = url;
HXLINE(  42)		this->target = target;
HXLINE(  43)		this->align = align;
HXLINE(  44)		this->leftMargin = leftMargin;
HXLINE(  45)		this->rightMargin = rightMargin;
HXLINE(  46)		this->indent = indent;
HXLINE(  47)		this->leading = leading;
            	}
...
bool TextFormat_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::text::TextFormat TextFormat_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c5f39c48023aa9de_52_clone)
HXLINE(  54)		 ::openfl::text::TextFormat newFormat =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,this->font,this->size,this->color,this->bold,this->italic,this->underline,this->url,this->target,null(),null(),null(),null(),null());
HXLINE(  56)		newFormat->align = this->align;
HXLINE(  57)		newFormat->leftMargin = this->leftMargin;
HXLINE(  58)		newFormat->rightMargin = this->rightMargin;
HXLINE(  59)		newFormat->indent = this->indent;
HXLINE(  60)		newFormat->leading = this->leading;
HXLINE(  62)		newFormat->blockIndent = this->blockIndent;
HXLINE(  63)		newFormat->bullet = this->bullet;
HXLINE(  64)		newFormat->kerning = this->kerning;
HXLINE(  65)		newFormat->letterSpacing = this->letterSpacing;
HXLINE(  66)		newFormat->tabStops = this->tabStops;
HXLINE(  68)		return newFormat;
            	}
...
void TextFormat_obj::_hx___merge( ::openfl::text::TextFormat format){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_73___merge)
HXLINE(  75)		if (hx::IsNotNull( format->font )) {
HXLINE(  75)			this->font = format->font;
            		}
HXLINE(  76)		if (hx::IsNotNull( format->size )) {
HXLINE(  76)			this->size = format->size;
            		}
HXLINE(  77)		if (hx::IsNotNull( format->color )) {
HXLINE(  77)			this->color = format->color;
            		}
HXLINE(  78)		if (hx::IsNotNull( format->bold )) {
HXLINE(  78)			this->bold = format->bold;
            		}
HXLINE(  79)		if (hx::IsNotNull( format->italic )) {
HXLINE(  79)			this->italic = format->italic;
            		}
HXLINE(  80)		if (hx::IsNotNull( format->underline )) {
HXLINE(  80)			this->underline = format->underline;
            		}
HXLINE(  81)		if (hx::IsNotNull( format->url )) {
HXLINE(  81)			this->url = format->url;
            		}
HXLINE(  82)		if (hx::IsNotNull( format->target )) {
HXLINE(  82)			this->target = format->target;
            		}
HXLINE(  83)		if (hx::IsNotNull( format->align )) {
HXLINE(  83)			this->align = format->align;
            		}
HXLINE(  84)		if (hx::IsNotNull( format->leftMargin )) {
HXLINE(  84)			this->leftMargin = format->leftMargin;
            		}
HXLINE(  85)		if (hx::IsNotNull( format->rightMargin )) {
HXLINE(  85)			this->rightMargin = format->rightMargin;
            		}
HXLINE(  86)		if (hx::IsNotNull( format->indent )) {
HXLINE(  86)			this->indent = format->indent;
            		}
HXLINE(  87)		if (hx::IsNotNull( format->leading )) {
HXLINE(  87)			this->leading = format->leading;
            		}
HXLINE(  88)		if (hx::IsNotNull( format->blockIndent )) {
HXLINE(  88)			this->blockIndent = format->blockIndent;
            		}
HXLINE(  89)		if (hx::IsNotNull( format->bullet )) {
HXLINE(  89)			this->bullet = format->bullet;
            		}
HXLINE(  90)		if (hx::IsNotNull( format->kerning )) {
HXLINE(  90)			this->kerning = format->kerning;
            		}
HXLINE(  91)		if (hx::IsNotNull( format->letterSpacing )) {
HXLINE(  91)			this->letterSpacing = format->letterSpacing;
            		}
HXLINE(  92)		if (hx::IsNotNull( format->tabStops )) {
HXLINE(  92)			this->tabStops = format->tabStops;
            		}
            	}
