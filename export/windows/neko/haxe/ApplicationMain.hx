...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "BuffersPlease2", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "BuffersPlease2";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "BuffersPlease2", null, { width: 640, height: 480 });
